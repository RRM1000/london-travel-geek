...
export function listing(o) {
  return {
    ...
    url: o.url ?? "",
    source: o.source,
    longRun: Boolean(o.longRun),       // an open-ended or 12-week-plus run: Long Runs tab, not the page
  };
}
