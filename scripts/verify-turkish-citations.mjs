// Checks every "Cited by N sources" and every printed rank in the turkish
// article against data/evidence.json and the sources' own quotes in
// data/consensus/turkish.json.
//
...
const TOPIC = "turkish";
const art = fs.readFileSync("src/content/articles/best-turkish-restaurants-london.md", "utf8");
