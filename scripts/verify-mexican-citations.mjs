// Checks every "Cited by N sources" and every printed rank in the mexican
// article against data/evidence.json and the sources' own quotes in
// data/consensus/mexican.json.
//
...
const TOPIC = "mexican";
const art = fs.readFileSync("src/content/articles/best-mexican-restaurants-london.md", "utf8");
