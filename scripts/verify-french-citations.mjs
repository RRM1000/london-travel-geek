// Checks every "Cited by N sources" and every printed rank in the french
// article against data/evidence.json and the sources' own quotes in
// data/consensus/french.json.
//
...
const TOPIC = "french";
const art = fs.readFileSync("src/content/articles/best-french-restaurants-london.md", "utf8");
