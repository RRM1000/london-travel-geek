...
const HOODS = {
  ...
  // Added for the September 2026 filming-location pass.
  "Borough":           { zone: "1",    district: "Central" },
  ...
  "West Kensington":   { zone: "2",    district: "West" },
  ...
  "Hampstead Garden Suburb": { zone: "3",    district: "North" },
};
...
const ROWS = [
  // ------------------------------ filming locations, September 2026 ---
  {
    ...base, slug: "leadenhall-market-diagon-alley", name: "Leadenhall Market as Diagon Alley", type: "filming-location", scheme: "",
    subject: "Harry Potter and the Philosopher's Stone (2001) - Diagon Alley and the Leaky Cauldron",
    hood: "City of London", borough: "City of London", areaGuide: "city-of-london-area-guide",
    address: "Gracechurch Street EC3V 1LT",
    whyGo: "The Victorian arcade played Diagon Alley in the first film, and the blue door that served as the entrance to the Leaky Cauldron belongs to what is now an opticians on Bull's Head Passage. The painted ironwork and glass roof needed no set dressing at all.",
    opSummary: "A working market, open to walk through in the daytime. The shops and bars keep City hours, so it is quiet at weekends.",
    source: "VisitBritain Harry Potter filming locations guide, cross-checked against movie-locations.com",
  },
  {
    ...base, slug: "kings-cross-platform-nine-three-quarters", name: "Platform 9 3/4", type: "filming-location", scheme: "",
    subject: "Harry Potter series - the barrier to the Hogwarts Express",
    hood: "King's Cross", borough: "Camden", areaGuide: "kings-cross-area-guide",
    address: "King's Cross station N1C 4AP",
    whyGo: "The on-screen barrier was shot between platforms 4 and 5. The trolley now embedded in a wall for photographs sits in the western departures concourse, nowhere near either. Both facts are true and the queue does not care.",
    opSummary: "Free to look at, inside the station. The trolley has a managed queue with a photographer and a shop attached - expect to wait at weekends and in school holidays.",
    source: "VisitBritain Harry Potter filming locations guide",
  },
  {
    ...base, slug: "millennium-bridge-death-eaters", name: "The Millennium Bridge", type: "filming-location", scheme: "",
    subject: "Harry Potter and the Half-Blood Prince (2009) - Death Eaters destroy the bridge",
    hood: "South Bank", borough: "Southwark", areaGuide: "south-bank-area-guide",
    address: "Millennium Bridge SE1 9JE",
    whyGo: "Collapsed into the Thames in the opening minutes of the sixth film. In reality it is the pedestrian bridge from St Paul's to Tate Modern, and the walk across it gives the best straight-on view of the cathedral in London.",
    opSummary: "Free, open at all times, busiest at weekends. Two minutes from Tate Modern.",
    source: "VisitBritain Harry Potter filming locations guide",
  },
  {
    ...base, slug: "claremont-square-grimmauld-place", name: "Claremont Square", type: "filming-location", scheme: "",
    subject: "Harry Potter and the Order of the Phoenix (2007) - the model for 12 Grimmauld Place",
    hood: "Islington", borough: "Islington", areaGuide: "islington-area-guide",
    address: "Claremont Square N1 9LY",
    whyGo: "The Grimmauld Place exterior was a set built at Leavesden, but it was modelled on this Georgian terrace above the Angel - which is why the square looks so familiar and so slightly wrong at the same time.",
    opSummary: "A private residential square with a covered reservoir behind railings at its centre. Viewable from the pavement only; people live here.",
    source: "Harry Potter London location guides, cross-checked against movie-locations.com",
  },
  {
    ...base, slug: "london-zoo-reptile-house", name: "London Zoo's Reptile House", type: "filming-location", scheme: "",
    subject: "Harry Potter and the Philosopher's Stone (2001) - Harry talks to the boa constrictor",
    hood: "Camden Town", borough: "Camden", areaGuide: "camden-area-guide",
    address: "ZSL London Zoo, Outer Circle NW1 4RY",
    whyGo: "The scene where Harry discovers he can speak to snakes and Dudley ends up behind the glass. The 1927 Reptile House is still in use and still recognisable.",
    opSummary: "Inside the zoo, so it needs a paid ticket - and the zoo is one of the more expensive attractions in London. Not worth the admission for the scene alone.",
    source: "VisitBritain Harry Potter filming locations guide",
  },
  {
    ...base, slug: "st-barts-sherlock-fall", name: "St Bartholomew's Hospital", type: "filming-location", scheme: "",
    subject: "Sherlock (2010-2017) - the fall from the roof in The Reichenbach Fall",
    hood: "City of London", borough: "City of London", areaGuide: "city-of-london-area-guide",
    address: "West Smithfield EC1A 7BE",
    whyGo: "Sherlock jumps from the roof of the pathology block and lands on the pavement below. Fans left so many notes on the phone box and the wall outside that the hospital had to manage it. Barts is also the oldest hospital in Britain still on its original site, founded in 1123.",
    opSummary: "A working hospital. The exterior and the square are public; the small museum keeps limited hours. Keep out of the way of patients.",
    source: "VisitBritain London film and TV itinerary, cross-checked against movie-locations.com",
  },
  {
    ...base, slug: "old-royal-naval-college-thor", name: "The Old Royal Naval College", type: "filming-location", scheme: "",
    subject: "Thor: The Dark World (2013) - the Greenwich finale",
    hood: "Greenwich", borough: "Greenwich", areaGuide: "greenwich-area-guide",
    address: "King William Walk SE10 9NN",
    whyGo: "Thor and Malekith fight through the colonnades in the film's climax, and Greenwich plays itself rather than standing in for anywhere. Wren's buildings have doubled for Paris, St Petersburg and Gotham in other productions.",
    opSummary: "The grounds are free and open daily. The Painted Hall is ticketed and worth it on its own terms.",
    source: "VisitBritain London film and TV itinerary",
  },
  {
    ...base, slug: "trafalgar-square-wonder-woman", name: "Trafalgar Square", type: "filming-location", scheme: "",
    subject: "Wonder Woman (2017) - the Armistice celebrations",
    hood: "Westminster", borough: "Westminster", areaGuide: "westminster-area-guide",
    address: "Trafalgar Square WC2N 5DN",
    whyGo: "Dressed as 1918 London for the film's closing celebration. The square has appeared as itself in more productions than almost anywhere else in the city.",
    opSummary: "Free and open at all times. The National Gallery on the north side is also free.",
    source: "VisitLondon film locations guide",
  },
  {
    ...base, slug: "canary-wharf-station-rogue-one", name: "Canary Wharf Underground Station", type: "filming-location", scheme: "",
    subject: "Rogue One: A Star Wars Story (2016) - Imperial interiors",
    hood: "Canary Wharf", borough: "Tower Hamlets", areaGuide: "canary-wharf-area-guide",
    address: "Canary Wharf station E14 5NY",
    whyGo: "Norman Foster's cathedral-scale ticket hall played an Imperial facility, which needed almost no set dressing beyond lighting - the concrete vaults already look like something the Empire would build.",
    opSummary: "A working Jubilee line station. Quietest at weekends, when the Wharf empties.",
    source: "VisitBritain London film and TV itinerary",
  },
  {
    ...base, slug: "blackfriars-bridge-mission-impossible", name: "Blackfriars Bridge", type: "filming-location", scheme: "",
    subject: "Mission: Impossible - Fallout (2018) - the rooftop and bridge chase",
    hood: "City of London", borough: "City of London", areaGuide: "city-of-london-area-guide",
    address: "Blackfriars Bridge EC4V 3QQ",
    whyGo: "Tom Cruise runs along the top of the bridge during the chase that ends at Tate Modern, having already run across the roof of Blackfriars station.",
    opSummary: "Free, open at all times. The best view of the run is from the Thames Path on the south bank.",
    source: "VisitBritain Mission: Impossible filming locations guide",
  },
  {
    ...base, slug: "somerset-house-goldeneye", name: "Somerset House", type: "filming-location", scheme: "",
    subject: "GoldenEye (1995) - the St Petersburg tank chase",
    hood: "Covent Garden", borough: "Westminster", areaGuide: "covent-garden-area-guide",
    address: "Strand WC2R 1LA",
    whyGo: "Bond drives a tank through St Petersburg in a courtyard three minutes from Waterloo Bridge. The neoclassical facades were close enough to Russian imperial architecture to pass, so the production never left London.",
    opSummary: "The courtyard is free and open daily - fountains in summer, an ice rink in winter. Exhibitions inside are ticketed.",
    source: "Time Out, London on Screen: how GoldenEye turned Somerset House into St Petersburg",
  },
  {
    ...base, slug: "hatton-garden-eyes-wide-shut", name: "Hatton Garden", type: "filming-location", scheme: "",
    subject: "Eyes Wide Shut (1999) - the Greenwich Village street where Bill is followed",
    hood: "Clerkenwell", borough: "Camden", areaGuide: "islington-area-guide",
    address: "Hatton Garden EC1N 8LX",
    whyGo: "Kubrick would not fly to New York, so American shopfronts and a payphone were added to this stretch of London's jewellery quarter to turn it into Greenwich Village. It is the clearest example in the city of London playing somewhere else entirely.",
    opSummary: "A working street of jewellers, open in shop hours and busy on weekdays. Nothing marks the location.",
    source: "movie-locations.com Eyes Wide Shut location list",
  },
  {
    ...base, slug: "british-museum-mummy-returns", name: "The British Museum", type: "filming-location", scheme: "",
    subject: "The Mummy Returns (2001) - the museum sequence",
    hood: "Bloomsbury", borough: "Camden", areaGuide: "bloomsbury-area-guide",
    address: "Great Russell Street WC1B 3DG",
    whyGo: "Filmed at the museum itself, though the exterior shots used UCL's front quad up the road because the real facade was behind scaffolding at the time. Two Bloomsbury buildings, one museum, in the same film.",
    opSummary: "Free and open daily. Use the Montague Place entrance at the back to avoid the main queue.",
    source: "movie-locations.com The Mummy Returns location list",
  },
  {
    ...base, slug: "national-gallery-skyfall", name: "The National Gallery", type: "filming-location", scheme: "",
    subject: "Skyfall (2012) - Bond meets Q in front of The Fighting Temeraire",
    hood: "Westminster", borough: "Westminster", areaGuide: "westminster-area-guide",
    address: "Trafalgar Square WC2N 5DN",
    whyGo: "Bond and Q sit on a bench in front of Turner's painting of a warship being towed away to be broken up, and the scene makes its point about obsolescence without anybody having to say it. The painting is on permanent display and free to see.",
    opSummary: "Free and open daily, with one late evening a week. Ask at the desk for the Turner rooms - they get asked constantly.",
    source: "VisitLondon film locations guide",
  },
  {
    ...base, slug: "great-george-street-spectre", name: "The Treasury Building, Great George Street", type: "filming-location", scheme: "",
    subject: "Spectre (2015) - the government exteriors",
    hood: "Westminster", borough: "Westminster", areaGuide: "westminster-area-guide",
    address: "Great George Street SW1P 3AL",
    whyGo: "The Edwardian government block off Whitehall stands in for the security establishment Bond spends the film fighting. The Churchill War Rooms sit underneath the same building.",
    opSummary: "Viewable from the street; the building is not open to the public. The War Rooms below are ticketed and need booking ahead.",
    source: "VisitLondon film locations guide",
  },
  {
    ...base, slug: "paddington-station-last-night-in-soho", name: "Paddington Station", type: "filming-location", scheme: "",
    subject: "Last Night in Soho (2021) - Eloise arrives in London",
    hood: "Paddington", borough: "Westminster", areaGuide: "paddington-area-guide",
    address: "Praed Street W2 1HQ",
    whyGo: "Eloise steps off the train from Cornwall under Brunel's roof, and the film begins its slow turn from wonder to dread. The same shed appears in both Paddington films, for reasons that need no explanation.",
    opSummary: "A working terminus, free to walk through. The Paddington Bear statue on platform 1 is the other reason people stop.",
    source: "movie-locations.com Last Night in Soho location list",
  },
  {
    ...base, slug: "parliament-square-v-for-vendetta", name: "Parliament Square", type: "filming-location", scheme: "",
    subject: "V for Vendetta (2005) - the march on Parliament",
    hood: "Westminster", borough: "Westminster", areaGuide: "westminster-area-guide",
    address: "Parliament Square SW1P 3JX",
    whyGo: "Bridge Street and Parliament Street were closed overnight to film the masked crowd converging on Westminster. The mask has since escaped the film entirely and turns up at real protests in the same square.",
    opSummary: "Free and open at all times, though the square is often partly fenced for works or demonstrations.",
    source: "movie-locations.com V for Vendetta location list",
  },
  ...
  // ------------- TENTH PASS: filming locations, September 2026 -------------
  {
    ...base, slug: "ten-trinity-square-skyfall", name: "Ten Trinity Square", type: "filming-location", scheme: "",
    subject: "Skyfall (2012) - M is summoned to meet the incoming Gareth Mallory",
    hood: "City of London", borough: "City of London", areaGuide: "city-of-london-area-guide",
    address: "10 Trinity Square", postcode: "EC3N 4AJ",
    whyGo: "The Beaux-Arts former Port of London Authority headquarters, now a Four Seasons hotel, playing the establishment room where M gets told her time is up. The rotunda and the coffered ceiling are the shot, and they are still exactly as filmed.",
    opSummary: "A working hotel, so the lobby and bars are open to non-residents. Two minutes from Tower Hill. Free to walk in and look; you are expected to buy something if you sit down.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "broadgate-tower-skyfall-shanghai", name: "Broadgate Tower", type: "filming-location", scheme: "",
    subject: "Skyfall (2012) - the neon tower standing in for Shanghai",
    hood: "City of London", borough: "City of London", areaGuide: "city-of-london-area-guide",
    address: "Primrose Street entrance, 201 Bishopsgate", postcode: "EC2M 3AB",
    whyGo: "The glass lift shaft Bond rides up behind the assassin Patrice, dressed with blue neon to pass for a Shanghai skyscraper. London playing another city entirely, and doing it a hundred metres from Liverpool Street.",
    opSummary: "An office building - the lobby is not a visitor attraction and you are looking at the exterior and the Primrose Street entrance. Free, on a public street, two minutes from Liverpool Street.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "55-whitehall-skyfall-rooftop", name: "55 Whitehall", type: "filming-location", scheme: "",
  ...
  {
    ...base, slug: "stanley-gardens-spectre-flat", name: "Stanley Gardens", type: "filming-location", scheme: "",
    subject: "Spectre (2015) - the exterior of Bond's own London flat",
    hood: "Notting Hill", borough: "Kensington and Chelsea", areaGuide: "notting-hill-area-guide",
    address: "Stanley Gardens", postcode: "W11",
    whyGo: "The stucco terrace used for where James Bond actually lives, which the films almost never show. Notting Hill rather than Chelsea or Mayfair, which surprised a lot of people at the time.",
    opSummary: "A residential street - people live here. Free to walk down, always open, five minutes from Notting Hill Gate. Look, do not linger at doorways.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "camden-lock-spectre-mi6", name: "Camden Lock", type: "filming-location", scheme: "",
    subject: "Spectre (2015) - the entrance to MI6's temporary headquarters",
    hood: "Camden Town", borough: "Camden", areaGuide: "camden-area-guide",
    address: "Camden Lock, Regent's Canal", postcode: "NW1 8AF",
    whyGo: "The working canal lock dressed as the covert river entrance to MI6's new home. In reality it is the busiest few square metres in Camden, with a market either side of it.",
    opSummary: "Free, open at all hours, though the market around it keeps daytime hours. Two minutes from Camden Town station and unavoidable if you are visiting the market anyway.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "mod-main-building-no-time-to-die", name: "Ministry of Defence Main Building", type: "filming-location", scheme: "",
    subject: "No Time To Die (2021) - Bond goes to see M",
    hood: "Whitehall", borough: "City of Westminster", areaGuide: "westminster-area-guide",
    address: "Horse Guards Avenue", postcode: "SW1A 2HB",
    whyGo: "The real MOD, used as itself rather than as a stand-in, which the Bond films rarely bother with. A vast Portland stone slab between Whitehall and the river that most visitors walk past without registering.",
    opSummary: "No public access whatsoever. Exterior only, from Horse Guards Avenue or Victoria Embankment, free and always visible. Five minutes from Embankment or Westminster.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "roupell-street-no-time-to-die", name: "Roupell Street", type: "filming-location", scheme: "",
    subject: "No Time To Die (2021) - Bond and Moneypenny call on Q at home",
    hood: "Waterloo", borough: "Lambeth", areaGuide: "south-bank-area-guide",
    address: "Roupell Street", postcode: "SE1 8TB",
    whyGo: "A cobbled terrace of early nineteenth-century workers' cottages a few minutes behind Waterloo, used as the street Q lives on. It is the most complete pre-Victorian street in the area and looks it.",
    opSummary: "A residential conservation area, free and open, best in daylight. Three minutes from Waterloo East, and the Kings Arms on the corner is a genuinely good pub.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "malaysia-house-living-daylights", name: "Malaysia House", type: "filming-location", scheme: "",
    subject: "The Living Daylights (1987) - the exterior of Universal Exports",
    hood: "Westminster", borough: "City of Westminster", areaGuide: "westminster-area-guide",
    address: "57 Trafalgar Square", postcode: "WC2N 5DU",
    whyGo: "The building used as Universal Exports, the shipping company that was MI6's cover identity through the older films. It sits on the corner of Trafalgar Square, which makes it the least covert secret headquarters imaginable.",
    opSummary: "Exterior only. Free, always visible, on the north-west corner of Trafalgar Square, two minutes from Charing Cross.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "stoney-street-leaky-cauldron", name: "Stoney Street", type: "filming-location", scheme: "",
    subject: "Harry Potter and the Prisoner of Azkaban (2004) - the Leaky Cauldron exterior",
    hood: "Borough", borough: "Southwark", areaGuide: "south-bank-area-guide",
    address: "Stoney Street", postcode: "SE1 9AA",
    whyGo: "The third film moved the Leaky Cauldron here, to the brick railway arches on the edge of Borough Market - a completely different building from the Leadenhall Market version used in the first film. Both are canon and both are in London.",
    opSummary: "Free and open, a public street through the market. Borough Market's own trading hours make the difference between atmospheric and deserted; London Bridge station is two minutes away.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "scotland-place-ministry-of-magic", name: "Scotland Place", type: "filming-location", scheme: "",
    subject: "Harry Potter and the Order of the Phoenix (2007) - the Ministry of Magic visitor entrance",
    hood: "Whitehall", borough: "City of Westminster", areaGuide: "westminster-area-guide",
    address: "Scotland Place", postcode: "SW1A 2HN",
    whyGo: "The narrow street off Whitehall where Harry and Mr Weasley climb into a red telephone box and descend into the Ministry. A genuine dead end behind Great Scotland Yard, and the reason it was chosen is that it looks like nowhere.",
    opSummary: "Free, a public street, always open. The telephone box was a prop and is not there. Two minutes from Charing Cross.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "heathgate-hermione-memory-charm", name: "Heathgate", type: "filming-location", scheme: "",
    subject: "Harry Potter and the Deathly Hallows: Part 1 (2010) - Hermione erases her parents' memories",
    hood: "Hampstead Garden Suburb", borough: "Barnet", areaGuide: "",
    address: "Heathgate", postcode: "NW11",
    whyGo: "The suburban street used for Hermione's family home in the film's quietest and most devastating scene, where she wipes herself out of her parents' memory before leaving. Hampstead Garden Suburb was built as a model estate in 1907 and still looks staged.",
    opSummary: "A residential street with no marker of any kind. Free and open, but a long way out - Golders Green then a bus, or a twenty-minute walk. For completists rather than casual visitors.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "the-hempel-notting-hill-reception", name: "The Hempel Zen Garden", type: "filming-location", scheme: "",
    subject: "Notting Hill (1999) - William and Anna's wedding reception",
    hood: "Bayswater", borough: "City of Westminster", areaGuide: "paddington-area-guide",
    address: "31-35 Craven Hill Gardens", postcode: "W2 3EA",
    whyGo: "The walled garden used for the wedding reception at the end of the film, in a hotel that was one of the first minimalist design hotels in London. It is a private garden square rather than a park.",
    opSummary: "Part of a hotel - access depends on the hotel, not on the public. Free to see the square from the street. Ten minutes from Paddington or Lancaster Gate.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "saints-tattoo-portobello", name: "201 Portobello Road", type: "filming-location", scheme: "",
    subject: "Notting Hill (1999) - Spike's tattoo parlour",
    hood: "Notting Hill", borough: "Kensington and Chelsea", areaGuide: "notting-hill-area-guide",
    address: "201 Portobello Road", postcode: "W11 1LT",
    whyGo: "The shopfront used as the tattoo parlour where Spike acquires his ill-advised declaration of love. Portobello Road is full of Notting Hill locations and this is the one nobody photographs, which is its main appeal.",
    opSummary: "A working street with a market on Saturdays. Free and always visible; go early on a Saturday or on a weekday if you want the street to yourself. Ladbroke Grove is the nearest station.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "kenwood-house-notting-hill-shoot", name: "Kenwood House", type: "filming-location", scheme: "",
    subject: "Notting Hill (1999) - the period film shoot William walks into",
    hood: "Hampstead", borough: "Camden", areaGuide: "hampstead-area-guide",
    address: "Hampstead Lane", postcode: "NW3 7JR",
    whyGo: "The stately home where William blunders onto the set of Anna's costume drama and overhears her dismiss him through a headset. The house is genuinely free to enter and holds a Rembrandt self-portrait and a Vermeer.",
    opSummary: "Free entry to house and grounds, 10am to 5pm with last entry 4.30pm. Gospel Oak or Hampstead Heath by rail, or the 210 bus. The viewing gazebo in the grounds is one of London's best free panoramas.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "selfridges-love-actually-necklace", name: "Selfridges", type: "filming-location", scheme: "",
    subject: "Love Actually (2003) - Harry buys the necklace",
    hood: "Marylebone", borough: "City of Westminster", areaGuide: "marylebone-area-guide",
    address: "400 Oxford Street", postcode: "W1A 1AB",
    whyGo: "The jewellery counter where Rowan Atkinson gift-wraps a necklace with such elaborate slowness that Alan Rickman nearly gets caught. It is the funniest scene in the film and it happens in a real shop you can walk into.",
    opSummary: "A department store, free to enter, open daily. Bond Street or Marble Arch. Christmas is the thematically correct time and by far the worst time for crowds.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "south-molton-street-love-actually", name: "South Molton Street", type: "filming-location", scheme: "",
    subject: "Love Actually (2003) - the Christmas lights montage",
    hood: "Mayfair", borough: "City of Westminster", areaGuide: "mayfair-area-guide",
    address: "South Molton Street", postcode: "W1K 5RH",
    whyGo: "The pedestrianised street used in the film's opening montage of London at Christmas. Narrow, Georgian and hung with lights every December, which is precisely why it was picked.",
    opSummary: "Free, always open, pedestrian only. Two minutes from Bond Street. Worth timing for late November onwards when the lights go up.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "gabriels-wharf-love-actually", name: "Gabriel's Wharf", type: "filming-location", scheme: "",
    subject: "Love Actually (2003) - Daniel and Sam on the South Bank",
    hood: "South Bank", borough: "Lambeth", areaGuide: "south-bank-area-guide",
    address: "56 Upper Ground", postcode: "SE1 9PP",
    whyGo: "Where Liam Neeson's Daniel has the heart-to-heart with his stepson about being in love, with the river behind them. A small courtyard of independent shops and cafes that has survived the South Bank's redevelopment intact.",
    opSummary: "Free, open at all hours as a through route, with the shops keeping daytime hours. Five minutes from Waterloo, on the walk between the National Theatre and the OXO Tower.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "tabernacle-street-love-actually", name: "Tabernacle Street", type: "filming-location", scheme: "",
    subject: "Love Actually (2003) - the office where Colin delivers sandwiches",
    hood: "Shoreditch", borough: "Hackney", areaGuide: "shoreditch-area-guide",
    address: "Tabernacle Street", postcode: "EC2A 4NS",
    whyGo: "The street used for the office where Colin makes his catering rounds and his hopeless attempts at flirtation. Shoreditch standing in for a generic London workplace, before Shoreditch became a look.",
    opSummary: "Free, a public street, always open. Five minutes from Old Street or Moorgate.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "royal-exchange-buildings-bridget-jones", name: "Royal Exchange Buildings", type: "filming-location", scheme: "",
    subject: "Bridget Jones's Diary (2001) - the kiss in the snow",
    hood: "City of London", borough: "City of London", areaGuide: "city-of-london-area-guide",
    address: "Royal Exchange Buildings, Cornhill", postcode: "EC3V 3LR",
    whyGo: "The alley behind the Royal Exchange used for the film's final scene, with Bridget in her underwear in the snow and Mark Darcy going back for the coat. The snow was fake and the cold was not.",
    opSummary: "Free, a public passage, always open. Bank station is directly underneath it. The Royal Exchange itself is now shops and a bar.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "ica-bridget-jones-book-launch", name: "Institute of Contemporary Arts", type: "filming-location", scheme: "",
    subject: "Bridget Jones's Diary (2001) - the book launch",
    hood: "St James's", borough: "City of Westminster", areaGuide: "westminster-area-guide",
    address: "The Mall", postcode: "SW1Y 5AH",
    whyGo: "The Nash terrace on The Mall where Bridget delivers her catastrophic introduction to a room of publishing people. The ICA is a real arts centre and the bar she flounders in is a real bar.",
    opSummary: "Free to enter the building, bar and bookshop; exhibitions are ticketed. Closed Mondays. Two minutes from Charing Cross, through Admiralty Arch.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "albert-bridge-bridget-jones-baby", name: "Albert Bridge", type: "filming-location", scheme: "",
    subject: "Bridget Jones's Baby (2016) - carried across the bridge in labour",
    hood: "Chelsea", borough: "Kensington and Chelsea", areaGuide: "chelsea-area-guide",
    address: "Albert Bridge", postcode: "SW3 5RS",
    whyGo: "The pink-and-green suspension bridge where Mark and Jack carry Bridget between them after her waters break. It is lit by four thousand bulbs at night and is the prettiest crossing in London by some distance.",
    opSummary: "Free, open to pedestrians at all hours, best after dark when the bulbs are lit. Fifteen minutes from Sloane Square, or the 170 bus.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "aquatics-centre-bridget-jones-baby", name: "London Aquatics Centre", type: "filming-location", scheme: "",
    subject: "Bridget Jones's Baby (2016) - the ante-natal class",
    hood: "Stratford", borough: "Newham", areaGuide: "stratford-area-guide",
    address: "Queen Elizabeth Olympic Park", postcode: "E20 2ZQ",
    whyGo: "Zaha Hadid's wave-roofed Olympic pool, used for the ante-natal swimming scenes. It is one of the few 2012 venues that works better as a building than as a sports facility.",
    opSummary: "A working public pool - you can swim in it for a standard session fee, which is the best way to see the roof. Stratford or Stratford International, ten minutes' walk.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "the-gherkin-match-point", name: "30 St Mary Axe", type: "filming-location", scheme: "",
    subject: "Match Point (2005) - Chris lands his City job",
    hood: "City of London", borough: "City of London", areaGuide: "city-of-london-area-guide",
    address: "30 St Mary Axe", postcode: "EC3A 8BF",
    whyGo: "The Gherkin, used for the office where Woody Allen's social climber gets his foothold. Foster's tower was five years old when the film came out and already the most recognisable silhouette in the City.",
    opSummary: "An office building with no general public access; the top-floor bar is private. Free to photograph from Bury Court or St Mary Axe. Aldgate or Liverpool Street.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "royal-opera-house-match-point", name: "Royal Opera House", type: "filming-location", scheme: "",
    subject: "Match Point (2005) - the night at the opera",
    hood: "Covent Garden", borough: "City of Westminster", areaGuide: "covent-garden-area-guide",
    address: "Bow Street", postcode: "WC2E 9DD",
    whyGo: "Where Chris and Chloe take their box and the affair with Nola starts to take shape. The building is now branded the Royal Ballet and Opera, and its fifth-floor terrace bar is open to anyone without a ticket.",
    opSummary: "Free to walk into the foyer and up to Bar Cicoria on the fifth floor, noon to 11pm Monday to Saturday, noon to 7pm Sunday. Covent Garden station, three minutes.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "tate-modern-match-point", name: "Tate Modern", type: "filming-location", scheme: "",
    subject: "Match Point (2005) - the gallery opening",
    hood: "South Bank", borough: "Southwark", areaGuide: "south-bank-area-guide",
    address: "Bankside", postcode: "SE1 9TG",
    whyGo: "The gallery where Chris runs into Nola again and the film turns. The Turbine Hall does a lot of work in British cinema as shorthand for the moneyed art world.",
    opSummary: "Free entry to the collection, daily 10am to 6pm, with Level 10's free viewing bar open to 9pm on Fridays and Saturdays. Southwark or Blackfriars, or across the Millennium Bridge from St Paul's.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "clarence-gate-gardens-match-point", name: "Clarence Gate Gardens", type: "filming-location", scheme: "",
    subject: "Match Point (2005) - Nola's flat, and the murder",
    hood: "Marylebone", borough: "City of Westminster", areaGuide: "marylebone-area-guide",
    address: "Glentworth Street", postcode: "NW1 6AU",
    whyGo: "The red-brick mansion block used for Nola's flat and for the film's central crime. Edwardian, enormous and anonymous, which is exactly what the plot requires.",
    opSummary: "Private flats - exterior only, from a public street. Free and always visible, two minutes from Baker Street, on the way to Regent's Park.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "kofee-espresso-air-street-mi", name: "Air Street", type: "filming-location", scheme: "",
    subject: "Mission: Impossible - Rogue Nation (2015) - Hunt receives his assignment",
    hood: "Soho", borough: "City of Westminster", areaGuide: "soho-area-guide",
    address: "Air Street", postcode: "W1B 5AA",
    whyGo: "The record-shop-turned-cafe where Ethan Hunt is handed his mission in the back room. Air Street is the short arcade linking Regent Street to Piccadilly and is easy to miss twice a day.",
    opSummary: "Free, a public street through an arcade, always open. One minute from Piccadilly Circus.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "middle-temple-cloisters-mi", name: "Middle Temple Cloisters", type: "filming-location", scheme: "",
    subject: "Mission: Impossible - Rogue Nation (2015) - Ilsa fights off an assassin",
    hood: "Holborn", borough: "City of London", areaGuide: "",
    address: "Middle Temple Lane", postcode: "EC4Y 9AT",
    whyGo: "The Inn of Court's cloisters, used for a knife fight in a set of buildings that have been lawyers' chambers since the fourteenth century. The quiet is the point - it is a walled legal quarter in the middle of the city.",
    opSummary: "The Temple is private land but the lanes are open to walk through on weekdays during working hours, and closed at weekends. Free. Temple station, closed on Sundays, or Blackfriars.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "throgmorton-avenue-mi", name: "Throgmorton Avenue", type: "filming-location", scheme: "",
    subject: "Mission: Impossible - Rogue Nation (2015) - Solomon Lane goes through a window",
    hood: "City of London", borough: "City of London", areaGuide: "city-of-london-area-guide",
    address: "Throgmorton Avenue", postcode: "EC2N 2AT",
    whyGo: "The gated City lane where the villain confronts Hunt and exits through plate glass. It is a private road with iron gates at both ends, which is why it looks so unlike a normal street.",
    opSummary: "Free to walk through on weekdays; the gates are closed at night and at weekends, which catches people out. Two minutes from Bank or Moorgate.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "tower-bridge-far-from-home", name: "Tower Bridge, West Upper Walkway", type: "filming-location", scheme: "",
    subject: "Spider-Man: Far From Home (2019) - the battle for the bridge",
    hood: "City of London", borough: "Tower Hamlets", areaGuide: "city-of-london-area-guide",
    address: "Tower Bridge", postcode: "SE1 2UP",
    whyGo: "The high-level walkway where the film's climax plays out, glass floor and all. It is the same walkway you can stand on with an £18 ticket, which makes this one of the few blockbuster finales you can literally visit.",
    opSummary: "The Exhibition is £18 adult, daily 9.30am to 6pm with last entry at 5pm, and there is lift access to the walkways. The bridge itself and its pavements are free at all hours. Tower Hill, two minutes.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "the-shard-far-from-home", name: "The Shard", type: "filming-location", scheme: "",
    subject: "Spider-Man: Far From Home (2019) - Fury and Hill watch the drone attack",
    hood: "South Bank", borough: "Southwark", areaGuide: "south-bank-area-guide",
    address: "32 London Bridge Street", postcode: "SE1 9SG",
    whyGo: "Where Nick Fury and Maria Hill watch London come apart from a great height. The building has appeared in more London-under-attack sequences than any other since it topped out in 2012.",
    opSummary: "The View from The Shard occupies floors 68 to 72, including an open-air deck; hours change by date so check the calendar. Aqua Shard on level 31 has no admission fee if you book a table. London Bridge station is underneath.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "alexandra-palace-theatre-far-from-home", name: "Alexandra Palace Theatre", type: "filming-location", scheme: "",
    subject: "Spider-Man: Far From Home (2019) - testing Mysterio's illusions",
    hood: "Muswell Hill", borough: "Haringey", areaGuide: "",
    address: "Alexandra Palace Way", postcode: "N22 7AY",
    whyGo: "The Victorian theatre inside Alexandra Palace, used as the space where Mysterio's holographic deceptions get rehearsed. It sat derelict for most of a century and reopened in 2018, deliberately half-restored, with the decay left visible.",
    opSummary: "A working theatre - access depends on the programme, so check what is on. The surrounding park and its free south-facing terrace are open day and night, all year. Alexandra Palace station or Wood Green.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "tower-of-london-far-from-home", name: "Tower of London", type: "filming-location", scheme: "",
    subject: "Spider-Man: Far From Home (2019) - the school trip arrives",
    hood: "City of London", borough: "Tower Hamlets", areaGuide: "city-of-london-area-guide",
    address: "St Katharine's & Wapping", postcode: "EC3N 4AB",
    whyGo: "The visitors' entrance where Happy Hogan delivers the school party, on the London leg of the film's European tour. The Tower gets destroyed later, which the guidebooks tend to leave out.",
    opSummary: "Ticketed and expensive, and busiest between 11am and 3pm. The moat, the wharf and the view of the White Tower from the free pavement cost nothing. Tower Hill, two minutes.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "st-bartholomew-the-great-sherlock-holmes", name: "St Bartholomew the Great", type: "filming-location", scheme: "",
    subject: "Sherlock Holmes (2009) - the interior standing in for St Paul's",
    hood: "Clerkenwell", borough: "City of London", areaGuide: "islington-area-guide",
    address: "West Smithfield", postcode: "EC1A 9DS",
    whyGo: "London's oldest surviving parish church, founded in 1123, its Norman interior standing in for St Paul's during the human-sacrifice scene. Four Weddings and Shakespeare in Love were shot here too - it is the most filmed church in the city.",
    opSummary: "A working church with a small admission charge for visitors and free entry for worship. Closed to sightseers during services. Barbican or Farringdon, five minutes.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "freemasons-hall-sherlock-holmes", name: "Freemasons' Hall", type: "filming-location", scheme: "",
    subject: "Sherlock Holmes (2009) - Lord Blackwood's masonic meeting",
    hood: "Holborn", borough: "Camden", areaGuide: "covent-garden-area-guide",
    address: "60 Great Queen Street", postcode: "WC2B 5AZ",
    whyGo: "The Art Deco Grand Temple used, appropriately, as a masonic lodge. The building is a 1930s memorial to freemasons killed in the First World War and the scale of the interior genuinely surprises people.",
    opSummary: "Free to visit, with a free museum and library, Monday to Saturday. Guided tours of the Grand Temple run daily and are also free. Covent Garden or Holborn, five minutes.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "college-of-arms-sherlock-holmes", name: "College of Arms", type: "filming-location", scheme: "",
    subject: "Sherlock Holmes (2009) - Sir Thomas's house",
    hood: "City of London", borough: "City of London", areaGuide: "city-of-london-area-guide",
    address: "130 Queen Victoria Street", postcode: "EC4V 4BT",
    whyGo: "The 1670s brick building used as a grand private house, in reality the headquarters of English heraldry since the fifteenth century. The wrought-iron gates and the forecourt are the shot.",
    opSummary: "The Earl Marshal's Court is open free on weekdays during office hours; the rest of the building is not. Free to see the forecourt from Queen Victoria Street. Blackfriars or Mansion House.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "brompton-cemetery-sherlock-holmes", name: "Brompton Cemetery", type: "filming-location", scheme: "",
    subject: "Sherlock Holmes (2009) - Blackwood rises from his tomb",
    hood: "Earl's Court", borough: "Kensington and Chelsea", areaGuide: "kensington-area-guide",
    address: "Old Brompton Road", postcode: "SW10 9UG",
    whyGo: "One of the Magnificent Seven Victorian cemeteries, its catacombs and colonnade used for the resurrection scene. Thirty-five thousand monuments over forty acres, with a domed chapel at the end of a formal avenue.",
    opSummary: "Free and open daily, roughly dawn to dusk with hours shifting by season. West Brompton is at the north gate. The catacombs are normally closed and only open on occasional guided tours.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "wiltons-music-hall-the-krays", name: "Wilton's Music Hall", type: "filming-location", scheme: "",
    subject: "The Krays (1990) - the interior of the twins' nightclub",
    hood: "Wapping", borough: "Tower Hamlets", areaGuide: "wapping-area-guide",
    address: "1 Graces Alley", postcode: "E1 8JB",
    whyGo: "The oldest surviving grand music hall in the world, built in 1859 behind a row of terraced houses, used as the interior of the Krays' club. It has been deliberately conserved rather than restored, so the peeling paint is the point.",
    opSummary: "A working theatre and bar. The Mahogany Bar is free to walk into and open most evenings; the auditorium depends on the programme. Tower Hill or Shadwell, five minutes.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "royal-oak-columbia-road-the-krays", name: "The Royal Oak", type: "filming-location", scheme: "",
    subject: "The Krays (1990) - the pub gets smashed up",
    hood: "Bethnal Green", borough: "Tower Hamlets", areaGuide: "shoreditch-area-guide",
    address: "73 Columbia Road", postcode: "E2 7RG",
    whyGo: "The corner pub wrecked in the film's turf-war scene, on the street that fills with the flower market every Sunday. The exterior is largely unchanged.",
    opSummary: "A working pub with normal opening hours. Columbia Road Flower Market runs Sunday mornings only, roughly 8am to 3pm, and the street is impassable while it does. Hoxton is the nearest station.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "repton-boxing-club-the-gentlemen", name: "Repton Boxing Club", type: "filming-location", scheme: "",
    subject: "The Gentlemen (2019) - Coach's gym",
    hood: "Bethnal Green", borough: "Tower Hamlets", areaGuide: "shoreditch-area-guide",
    address: "Cheshire Street", postcode: "E2 6EH",
    whyGo: "The real East End boxing club used as Colin Farrell's gym, in a Victorian bathhouse. Repton has been going since 1884 and its alumni include Audley Harrison and the Kray twins, which is the reason film crews keep asking.",
    opSummary: "A working amateur club, not a visitor attraction - exterior only unless you are training. Free to see from Cheshire Street. Bethnal Green or Shoreditch High Street, and Brick Lane is two minutes away.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "st-georges-in-the-east-long-good-friday", name: "St George in the East", type: "filming-location", scheme: "",
    subject: "The Long Good Friday (1980) - the car bomb outside the church",
    hood: "Wapping", borough: "Tower Hamlets", areaGuide: "wapping-area-guide",
    address: "14 Cannon Street Road", postcode: "E1 0BH",
    whyGo: "Hawksmoor's 1729 church, where a bomb intended for Harold Shand nearly kills his mother. It was gutted in the Blitz and rebuilt with a modern church inside the surviving shell, which is why the interior is such a surprise.",
    opSummary: "Free and normally open during the day, with a churchyard that functions as a public garden. Shadwell on the Overground or DLR, three minutes.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "st-katharine-docks-long-good-friday", name: "St Katharine Docks", type: "filming-location", scheme: "",
    subject: "The Long Good Friday (1980) - Harold's yacht and the pier party",
    hood: "Wapping", borough: "Tower Hamlets", areaGuide: "wapping-area-guide",
    address: "50 St Katharine's Way", postcode: "E1W 1LA",
    whyGo: "The marina where Bob Hoskins holds court on his yacht and pitches his vision of a redeveloped Docklands - a speech the film treats as hubris and history proved right. The basin was one of the first docks converted, in 1973.",
    opSummary: "Free, open at all hours, ringed by pubs and restaurants keeping normal hours. Five minutes east of Tower Bridge, and Tower Hill is the nearest station.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "the-salisbury-long-good-friday", name: "The Salisbury Hotel", type: "filming-location", scheme: "",
    subject: "The Long Good Friday (1980) - Fagan's, the Irish pub",
    hood: "Harringay", borough: "Haringey", areaGuide: "",
    address: "1 Grand Parade, Green Lanes", postcode: "N4 1JX",
    whyGo: "An extravagantly ornate 1899 gin palace standing in for a fictional Irish pub. Etched glass, mahogany and a ceiling that has no business being in a suburban pub - it is Grade II* listed and largely intact.",
    opSummary: "A working pub with normal hours, free to walk into. Manor House on the Piccadilly line, five minutes, then a walk up Green Lanes.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "walton-house-boundary-estate-suffragette", name: "Boundary Estate", type: "filming-location", scheme: "",
    subject: "Suffragette (2015) - Maud Watts's home",
    hood: "Shoreditch", borough: "Tower Hamlets", areaGuide: "shoreditch-area-guide",
    address: "Walton House, Boundary Estate", postcode: "E2 7JQ",
    whyGo: "The world's first council housing estate, opened in 1900, used as the East End home of Carey Mulligan's laundry worker. Built on the cleared slum known as the Old Nichol, with the streets radiating from a raised bandstand on Arnold Circus.",
    opSummary: "Residential, so exterior and public streets only. Free and open at all hours. Arnold Circus at the centre is a small public garden. Shoreditch High Street, five minutes.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "central-lobby-suffragette", name: "Central Lobby, Houses of Parliament", type: "filming-location", scheme: "",
    subject: "Suffragette (2015) - the lobbying scene",
    hood: "Westminster", borough: "City of Westminster", areaGuide: "westminster-area-guide",
    address: "Houses of Parliament", postcode: "SW1A 0AA",
    whyGo: "The octagonal hall at the heart of the Palace of Westminster where the suffragettes confront the political machine. It was the first time a feature film had been permitted to shoot inside Parliament.",
    opSummary: "You can reach Central Lobby free by asking your MP for a meeting or attending a debate - that is the lobbying right the scene is about. Paid tours also run on Saturdays and in recess. Westminster station.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "clerkenwell-house-of-detention-suffragette", name: "Clerkenwell House of Detention", type: "filming-location", scheme: "",
    subject: "Suffragette (2015) - the Holloway prison cells",
    hood: "Clerkenwell", borough: "Islington", areaGuide: "islington-area-guide",
    address: "Sans Walk", postcode: "EC1R 0LT",
    whyGo: "The surviving underground cells of a Victorian prison, used as Holloway. Almost everything above ground was demolished; what is left is the basement, and it is genuinely grim.",
    opSummary: "Not open to the public - it operates as a private film and event location, and has been closed as a visitor attraction for years. Do not plan a visit around it. Farringdon is five minutes away.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "admiralty-building-ipcress-file", name: "Admiralty Building", type: "filming-location", scheme: "",
    subject: "The Ipcress File (1965) - Harry Palmer is summoned",
    hood: "St James's", borough: "City of Westminster", areaGuide: "westminster-area-guide",
    address: "The Mall", postcode: "SW1A 2WH",
    whyGo: "Where Michael Caine's insubordinate spy gets his orders, in the film that invented the bespectacled, working-class alternative to James Bond. The building is the old naval headquarters at the end of The Mall.",
    opSummary: "Government offices, no public access. Exterior only, free, always visible from The Mall or Horse Guards Parade. Charing Cross, five minutes.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "royal-albert-hall-steps-ipcress", name: "Royal Albert Hall steps", type: "filming-location", scheme: "",
    subject: "The Ipcress File (1965) - the fight on the steps",
    hood: "South Kensington", borough: "Kensington and Chelsea", areaGuide: "south-kensington-area-guide",
    address: "Kensington Gore", postcode: "SW7 2AP",
    whyGo: "The grand entrance steps used for a fight scene, with the Albert Memorial across the road. The hall opened in 1871 and the steps have barely changed.",
    opSummary: "Free to stand on. The building itself is ticketed by event, with guided tours running most days. South Kensington is ten minutes' walk through the museum tunnel.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "maryon-park-blowup", name: "Maryon Park", type: "filming-location", scheme: "",
    subject: "Blowup (1966) - the photographs, and the body in the undergrowth",
    hood: "Charlton", borough: "Greenwich", areaGuide: "greenwich-area-guide",
    address: "Thorntree Road", postcode: "SE7 8LN",
    whyGo: "The park where Antonioni's photographer shoots a couple and then, blowing up the negatives, finds what might be a corpse in the bushes. The tennis courts where the film ends with a mimed game are still there.",
    opSummary: "Free, open dawn to dusk, and genuinely quiet. Charlton station, five minutes. It is a proper park rather than a location - most people here are walking a dog.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "shepherds-bush-market-quadrophenia", name: "Shepherd's Bush Market", type: "filming-location", scheme: "",
    subject: "Quadrophenia (1979) - the chase through the market",
    hood: "Shepherd's Bush", borough: "Hammersmith and Fulham", areaGuide: "",
    address: "Goldhawk Road", postcode: "W12 8DG",
    whyGo: "Where Jimmy and the Mods pursue a Rocker through the stalls. The market has run under the railway viaduct since 1914 and has been threatened with redevelopment for most of the last decade.",
    opSummary: "Free and open, Monday to Saturday, roughly 9am to 6pm, closed Sundays. Goldhawk Road or Shepherd's Bush Market stations sit at either end of it.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "wilcox-road-my-beautiful-laundrette", name: "Wilcox Road", type: "filming-location", scheme: "",
    subject: "My Beautiful Laundrette (1985) - Powders, the launderette",
    hood: "Vauxhall", borough: "Lambeth", areaGuide: "",
    address: "Wilcox Road", postcode: "SW8 2XA",
    whyGo: "The street where Omar and Johnny do up the launderette, in the film that made Daniel Day-Lewis's name and put a gay interracial relationship on British screens in 1985. The shopfront was dressed for the film and is an ordinary parade again.",
    opSummary: "A residential street, free and open. Wandsworth Road station, or Stockwell on the Northern and Victoria lines, ten minutes.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "talgarth-road-trainspotting", name: "Talgarth Road", type: "filming-location", scheme: "",
    subject: "Trainspotting (1996) - Renton's London flat",
    hood: "West Kensington", borough: "Hammersmith and Fulham", areaGuide: "",
    address: "Talgarth Road", postcode: "W14 9DA",
    whyGo: "The Art Deco block used for the flat Renton takes when he moves south, in the film's brief and unhappy London chapter. It is on the A4, one of the loudest roads in west London, which suits the scene.",
    opSummary: "Residential, exterior only, free and always visible. Barons Court, three minutes. There is no reason to come for this alone.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "liverpool-street-elephant-man", name: "Liverpool Street Station", type: "filming-location", scheme: "",
    subject: "The Elephant Man (1980) - Merrick returns to London",
    hood: "City of London", borough: "City of London", areaGuide: "city-of-london-area-guide",
    address: "Liverpool Street", postcode: "EC2M 7PY",
    whyGo: "The terminus where John Merrick arrives back in London after escaping the continental freak show, and is chased into the gentlemen's lavatory by a crowd. Lynch shot it in black and white and the roof does most of the work.",
    opSummary: "Free, open around the clock as a working station. The 1875 train shed was rebuilt in the 1980s, so the ironwork you see is a reconstruction of what Lynch filmed.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "grosvenor-house-sexy-beast", name: "Grosvenor House Hotel", type: "filming-location", scheme: "",
    subject: "Sexy Beast (2000) - Gal in Mayfair under an alias",
    hood: "Mayfair", borough: "City of Westminster", areaGuide: "mayfair-area-guide",
    address: "86-90 Park Lane", postcode: "W1K 7TN",
    whyGo: "Where Ray Winstone's retired villain stays while the London job is on. Park Lane luxury as the reward at the end of the criminal career, which the film is deeply sceptical about.",
    opSummary: "A working hotel; public bars and restaurants are open to non-residents. Free to look. Marble Arch or Hyde Park Corner, ten minutes either way.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "chalcot-square-paddington-2", name: "Chalcot Square", type: "filming-location", scheme: "",
    subject: "Paddington 2 (2017) - Phoenix Buchanan's house",
    hood: "Primrose Hill", borough: "Camden", areaGuide: "camden-area-guide",
    address: "Chalcot Square", postcode: "NW1 8YA",
    whyGo: "The pastel terrace used for the home of Hugh Grant's washed-up actor. The same square supplied the Brown family's Windsor Gardens exterior in the first film, on the opposite side.",
    opSummary: "A residential garden square, free to walk around, always open. Chalk Farm, five minutes, and Primrose Hill itself is two streets away.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "little-venice-paddington-2", name: "Grand Union Canal, Little Venice", type: "filming-location", scheme: "",
    subject: "Paddington 2 (2017) - the towpath chase",
    hood: "Little Venice", borough: "City of Westminster", areaGuide: "paddington-area-guide",
    address: "Blomfield Road", postcode: "W9 2PF",
    whyGo: "Where Paddington pursues the real thief along the water. Little Venice is the junction of the Grand Union and Regent's Canal, lined with narrowboats and white stucco villas.",
    opSummary: "Free, the towpath is open at all hours, and the walk east to Camden takes about an hour. Warwick Avenue, two minutes. Boat trips to Camden Lock run in season.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "whispering-gallery-paddington-2", name: "The Whispering Gallery, St Paul's", type: "filming-location", scheme: "",
    subject: "Paddington 2 (2017) - the search for the pop-up book clue",
    hood: "City of London", borough: "City of London", areaGuide: "city-of-london-area-guide",
    address: "St Paul's Churchyard", postcode: "EC4M 8AD",
    whyGo: "The circular gallery inside the dome where a whisper against the wall carries round to the far side, used as Buchanan hunts for the next clue. It is 257 steps up, the first of the three galleries.",
    opSummary: "Included in the £27 adult sightseeing ticket, which also covers the Stone and Golden Galleries at 376 and 528 steps. Stairs only, no lift. Monday to Saturday, last entry around 4pm. St Paul's station.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "st-johns-square-paddington-2", name: "St John's Square", type: "filming-location", scheme: "",
    subject: "Paddington 2 (2017) - the theatrical agent's office",
    hood: "Clerkenwell", borough: "Islington", areaGuide: "islington-area-guide",
    address: "St John's Square", postcode: "EC1M 4DE",
    whyGo: "The Clerkenwell square used for the office where Buchanan's agent delivers bad news. St John's Gate, the Tudor arch across the square, is the surviving gatehouse of a twelfth-century priory.",
    opSummary: "Free, a public square, always open. The Museum of the Order of St John in the gatehouse is free and open Monday to Saturday. Farringdon, three minutes.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "liberty-cruella", name: "Liberty", type: "filming-location", scheme: "",
    subject: "Cruella (2021) - the opening heist and the job interview",
    hood: "Soho", borough: "City of Westminster", areaGuide: "soho-area-guide",
    address: "Great Marlborough Street", postcode: "",
    whyGo: "The mock-Tudor department store used as the fashion house Estella talks her way into. The building was put up in 1924 from the timbers of two Royal Navy warships, which is why the floors slope.",
    opSummary: "Free to walk into, open daily. Oxford Circus, two minutes. The atrium and the top-floor galleries are the parts worth the climb.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "pickering-place-cruella", name: "Pickering Place", type: "filming-location", scheme: "",
    subject: "Cruella (2021) - Wink opens the door onto the square",
    hood: "St James's", borough: "City of Westminster", areaGuide: "westminster-area-guide",
    address: "Pickering Place, St James's Street", postcode: "SW1A 1EA",
    whyGo: "London's smallest public square, reached down a wood-panelled passage beside Berry Bros & Rudd, used for one of the film's robberies. It is gas-lit, and it was reputedly the last place in London where a duel was fought.",
    opSummary: "Free, always open, though the passage is easy to walk past. Green Park, five minutes. Berry Bros has been selling wine on the corner since 1698.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "dukes-road-cruella", name: "Duke's Road", type: "filming-location", scheme: "",
    subject: "Cruella (2021) - the Dalmatians are taken from the grooming salon",
    hood: "Bloomsbury", borough: "Camden", areaGuide: "bloomsbury-area-guide",
    address: "Duke's Road", postcode: "WC1H 9PY",
    whyGo: "The short street dressed as Roscoe's Grooming Salon for the dognapping. Its real landmark is The Place, the contemporary dance theatre in the old Artillery drill hall.",
    opSummary: "Free, a public street, always open. Euston, five minutes. There is nothing marking the location.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "noel-coward-theatre-judy", name: "Noël Coward Theatre", type: "filming-location", scheme: "",
    subject: "Judy (2019) - the Talk of the Town exterior",
    hood: "Covent Garden", borough: "City of Westminster", areaGuide: "covent-garden-area-guide",
    address: "85-88 St Martin's Lane", postcode: "WC2N 4AP",
    whyGo: "The frontage used as the exterior of the Talk of the Town, the nightclub where Judy Garland played her final London residency in 1969. The real venue was the Hippodrome on Cranbourn Street, now a casino.",
    opSummary: "A working West End theatre - the foyer opens for performances. Free to see the frontage from St Martin's Lane. Leicester Square, three minutes.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "hackney-empire-judy", name: "Hackney Empire", type: "filming-location", scheme: "",
    subject: "Judy (2019) - the Talk of the Town interior",
    hood: "Hackney", borough: "Hackney", areaGuide: "hackney-area-guide",
    address: "291 Mare Street", postcode: "E8 1EJ",
    whyGo: "Frank Matcham's 1901 variety theatre, standing in for the interior of the nightclub. Charlie Chaplin and Stan Laurel played the real thing, and the terracotta and gilt interior survived a stint as a bingo hall.",
    opSummary: "A working theatre with a full programme including comedy. The foyer and bar open for shows. Hackney Central, three minutes.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "jerusalem-tavern-judy", name: "The Jerusalem Tavern", type: "filming-location", scheme: "",
    subject: "Judy (2019) - Judy and Mickey stop for a drink",
    hood: "Clerkenwell", borough: "Islington", areaGuide: "islington-area-guide",
    address: "55 Britton Street", postcode: "EC1M 5UQ",
    whyGo: "A single-room eighteenth-century shopfront pub, the London tap for St Peter's Brewery, used for a quiet scene between Garland and her last husband. It seats about thirty people and looks two hundred years older than it is licensed to be.",
    opSummary: "A working pub, normal hours, and often full by six on a weekday. Free to walk into. Farringdon, four minutes.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "lancaster-house-theory-of-everything", name: "Lancaster House", type: "filming-location", scheme: "",
    subject: "The Theory of Everything (2014) - Hawking receives his honour",
    hood: "St James's", borough: "City of Westminster", areaGuide: "westminster-area-guide",
    address: "Stable Yard, St James's", postcode: "SW1A 1BB",
    whyGo: "The Nash mansion used as Buckingham Palace, which it stands in for so often that The Crown used it for the same purpose. Its state rooms are more lavish than the real palace's, which is why.",
    opSummary: "Government hospitality venue with no general public access; it opens for occasional Open House weekends. Free to see the exterior from Stable Yard Road. Green Park, five minutes.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "eltham-palace-wonka", name: "Eltham Palace", type: "filming-location", scheme: "",
    subject: "Wonka (2023) - Slugworth's house",
    hood: "Eltham", borough: "Greenwich", areaGuide: "",
    address: "Court Yard", postcode: "SE9 5QE",
    whyGo: "A medieval royal palace with a 1930s Art Deco house grafted onto it, used as the villain's grand home. Henry VIII grew up here; the Courtaulds added a circular entrance hall with a glass dome in 1936.",
    opSummary: "English Heritage, ticketed, and closed on some winter weekdays - check before travelling. Mottingham or Eltham stations, fifteen minutes' walk. Free for members.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "admiralty-arch-children-of-men", name: "Admiralty Arch", type: "filming-location", scheme: "",
    subject: "Children of Men (2006) - the drive through the checkpoint",
    hood: "Westminster", borough: "City of Westminster", areaGuide: "westminster-area-guide",
    address: "The Mall", postcode: "SW1A 2WH",
    whyGo: "Theo is driven through crowds and a security checkpoint here, in a film that imagined a militarised London a decade before anyone found that plausible. The arch was built in 1912 as a memorial to Queen Victoria.",
    opSummary: "Free, always visible; the central gate opens only for ceremonial processions. It is being converted into a hotel, so the scaffolding is not permanent. Charing Cross, two minutes.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
  {
    ...base, slug: "blythe-house-danish-girl", name: "Blythe House", type: "filming-location", scheme: "",
    subject: "The Danish Girl (2015) - Lili escapes the clinic",
    hood: "West Kensington", borough: "Hammersmith and Fulham", areaGuide: "",
    address: "23 Blythe Road", postcode: "W14 0QX",
    whyGo: "The former Post Office Savings Bank headquarters, an enormous 1903 red-brick block that has spent decades as museum storage for the V&A, the Science Museum and the British Museum. Its corridors have stood in for institutions in a great many films.",
    opSummary: "No public access, and the collections are being moved out to V&A East. Exterior only, free, from Blythe Road. Kensington Olympia, five minutes.",
    source: "movie-locations.com (Tony Reeves), fetched 2 September 2026",
  },
];
