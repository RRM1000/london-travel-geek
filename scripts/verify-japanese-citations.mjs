// Checks every "Cited by N sources" and every printed rank in the japanese
// article against data/evidence.json and the sources' own quotes in
// data/consensus/japanese.json.
//
// Counts are TOPIC-SCOPED: evidence.json's sourceCount spans every corpus, and
// a single guide must not print that.
import fs from "node:fs";

const TOPIC = "japanese";
const art = fs.readFileSync("src/content/articles/best-japanese-restaurants-london.md", "utf8");
