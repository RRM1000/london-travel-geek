// Checks every "Cited by N sources" and every printed rank in the vegan
// article against data/evidence.json and the sources' own quotes in
// data/consensus/vegan.json.
//
...
const TOPIC = "vegan";
const art = fs.readFileSync("src/content/articles/best-vegetarian-vegan-restaurants-london.md", "utf8");
