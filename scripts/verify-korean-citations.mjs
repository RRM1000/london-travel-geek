// Checks every "Cited by N sources" and every printed rank in the korean
// article against data/evidence.json and the sources' own quotes in
// data/consensus/korean.json.
//
...
const TOPIC = "korean";
const art = fs.readFileSync("src/content/articles/best-korean-restaurants-london.md", "utf8");
