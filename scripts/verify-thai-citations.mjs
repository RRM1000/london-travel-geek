// Checks every "Cited by N sources" and every printed rank in the thai
// article against data/evidence.json and the sources' own quotes in
// data/consensus/thai.json.
//
...
const TOPIC = "thai";
const art = fs.readFileSync("src/content/articles/best-thai-restaurants-london.md", "utf8");
