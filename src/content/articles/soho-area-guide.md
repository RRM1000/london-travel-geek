...
area:
  name: "Soho"
  zone: "1"
  vibe: "Dense, loud and at its best after dark"
  walkability: 5
  ...
  nearestStations:
    - name: "Tottenham Court Road"
      lines: ["Elizabeth line", "Central", "Northern"]
  ...
  nearby:
    - name: "Covent Garden"
      ...
      minutes: 8
      note: "East across Charing Cross Road for the Piazza, Seven Dials and the theatres."
    - name: "Mayfair and Regent Street"
      minutes: 10
      note: "West across Regent Street for galleries, arcades and the expensive end of town."
    - name: "Bloomsbury"
      slug: "bloomsbury-area-guide"
      minutes: 12
      note: "North-east for the British Museum and a much quieter afternoon."
    - name: "South Bank"
      slug: "south-bank-area-guide"
      minutes: 20
      note: "South through Trafalgar Square and over the Golden Jubilee Bridges."
faq:
  - q: "Is Soho safe at night?"
    a: "Yes, in the sense that it is busy and well lit until very late. It is London's densest nightlife district, so expect crowds, noise and drunk people at closing time, particularly around Old Compton Street and Wardour Street on weekends. Normal city awareness applies: watch your bag and your phone in crowds."
  - q: "Where is Chinatown in London?"
    a: "Centred on Gerrard Street, between Shaftesbury Avenue and Leicester Square, marked by ornate gates at either end. It is pedestrianised and takes in Lisle Street and Newport Place as well. It is a five-minute walk from Piccadilly Circus or Leicester Square stations."
  - q: "What is Soho actually known for?"
    a: "Three overlapping things: eating and drinking, the music industry, and LGBTQ+ nightlife centred on Old Compton Street. Historically it was London's red-light district and its film and recording hub — Denmark Street was the country's centre for instrument shops and songwriting. Most of that character survives in fragments."
  - q: "Do I need to book restaurants in Soho?"
    a: "For dinner between Thursday and Saturday, yes. Many of the best-known places do not take bookings at all and run walk-in queues instead — go early, around 17:30, or late after 21:00. Chinatown is the reliable fallback, as most restaurants there seat quickly."
  - q: "Is Carnaby Street worth visiting?"
    a: "It is worth twenty minutes rather than an afternoon. The 1960s history is real but the street is now mostly mainstream chains. The better shopping is in Kingly Court just off it, a three-storey courtyard of independent restaurants and bars."
heroImage: ../../assets/articles/soho-area-guide/dean-street-old-compton-street-corner.jpg
heroImageAlt: "The corner of Old Compton Street and Dean Street in Soho"
heroImageCredit: "Philafrenzy"
heroImageSource: https://commons.wikimedia.org/wiki/File:Dean_Street_-_Old_Compton_Street_corner.JPG
heroImageLicense: "CC BY-SA 4.0"
heroImageLicenseUrl: https://creativecommons.org/licenses/by-sa/4.0
---

Soho is roughly one square kilometre bounded by Oxford Street, Regent Street, Shaftesbury Avenue and Charing Cross Road, and it contains more restaurants, bars, theatres and recording studios than anywhere else in Britain.
...
Soho has its own share of the commemorative plaques marking where notable people lived or worked. [Browse them on the map](/plaques/?area=soho).
