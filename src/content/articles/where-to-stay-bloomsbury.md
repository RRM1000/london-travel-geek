---
title: "Where to Stay in Bloomsbury — Hostel Bunks to a Grand Hotel, Minutes Apart"
seoTitle: "Where to Stay in Bloomsbury 2026: Hotels & Prices"
...
draft: false
faq:
  - q: "Is Bloomsbury a good area to stay in London?"
    a: "Yes, and for value more than for anything else. It is Zone 1, ten minutes' walk from St Pancras, five from the British Museum, and it runs a wider spread of room prices than any other central area — a shared hostel dorm and a fully rebuilt grand hotel both sit inside the same ten-minute walk. The trade-off is the evening: Bloomsbury is academic and residential, so it goes quiet after office hours, and the restaurant choice is nothing like Soho's a few minutes west."
  - q: "Is Bloomsbury cheap to stay in?"
    a: "At the bottom, yes — Generator London and the Cartwright Gardens and Gower Street B&B strip are among the cheapest private and dorm beds in Zone 1. But Bloomsbury also holds Kimpton Fitzroy London, The Bloomsbury Hotel and the newly rebuilt Imperial, all of them full-rate hotels on Russell Square. It is not a uniformly cheap postcode; it is a postcode where the cheap option happens to sit a few streets from the expensive one, which is unusual this close to the centre."
  - q: "Is there a hostel or budget option in Bloomsbury?"
    a: "Generator London, in a former police station on Tavistock Place, is the hostel — dorms of four to ten, female-only dorms, private rooms, and a bar built into a bus. It is an openly social, sometimes loud party hostel, which is the wrong booking the night before an early train. Below it in price but above a dorm, the Cartwright Gardens and Gower Street strip — Mentone, Ridgemount, Celtic, Arosfa and St Athans among them — is the classic Bloomsbury budget answer: family-run Georgian townhouse B&Bs, most with breakfast, several without a lift."
  - q: "Are any Bloomsbury hotel rooms windowless?"
    a: "Zedwell Tottenham Court Road is windowless by design rather than by compromise — it is built inside a former underground car park beneath Great Russell Street, London's first hotel that is entirely below ground, and every Cocoon room from the smallest to the largest has no window at all. That is the whole concept, not a cut-price grade hidden in a longer room list, and it is soundproofed and filtered-air by the same design choice."
  - q: "Is Bloomsbury quiet at night?"
