---
title: "Money in London: Cash, Cards, Cash Machines and Tipping Explained"
...
tags:
  ...
  - planning
draft: false
heroImage: "../../assets/articles/money-in-london/london-cash-machine.jpg"
heroImageAlt: "An illuminated independent Cashzone cash machine advertising cash withdrawals and balance enquiries, set into a brick wall on a London street at night"
heroImageCredit: "Tom Page"
heroImageSource: "https://commons.wikimedia.org/wiki/File:Cash_machine_on_Upper_Walthamstow_Road_E17.jpg"
heroImageLicense: "CC BY-SA 2.0"
heroImageLicenseUrl: "https://creativecommons.org/licenses/by-sa/2.0"
faq:
  - q: "Do I need cash in London?"
    a: "Not much, but not none. Transport, most shops, chain restaurants and every cashless stadium and arena run on contactless only. Cash still helps at market stalls, with buskers, in small independents, and as a tip in places that don't split card tips cleanly. £20–£40 in notes and a few pound coins covers a typical visit."
  - q: "Is London a cashless city?"
    a: "No, but large parts of it function that way. TfL's buses have taken no cash since 2014, and Wembley Stadium, the Tottenham Hotspur Stadium, The O2 arena and OVO Arena are all fully cashless. Most cafés, restaurants and shops still take cash, though by law they're entitled to refuse it."
  - q: "What's the contactless payment limit in London?"
    a: "£100 per tap at every major bank in March 2026. The Financial Conduct Authority scrapped the single regulatory cap in March 2026 and let banks set their own limit if they have strong fraud controls, but Barclays, HSBC, Lloyds, Nationwide, NatWest, Santander and Monzo have all kept £100 regardless, citing low customer demand for anything higher. Apple Pay and Google Pay aren't held to it, because your face or fingerprint authenticates each payment."
  - q: "Can I still use the old paper £20 and £50 notes?"
    a: "No. The last paper notes — the £20 and £50 Series F — stopped being legal tender on 30 September 2022, when the Bank of England completed the move to polymer. If you're holding one, it still has its face value: pay it into a UK bank account, or take it to one of 51 Post Office branches (if it's £300 or less and you have photo ID), or send it to the Bank of England directly, which will exchange old notes at any time, with no deadline."
  - q: "Are Scottish and Northern Irish banknotes accepted in London?"
    a: "Legally, they're not legal tender anywhere in the UK, including in Scotland and Northern Ireland themselves — that status only applies to Bank of England notes, and only in England and Wales. In practice, most London banks, shops and machines will take them, but not all: acceptance is at a shop's discretion, and occasional refusals of a Scottish £20 or £50 are reported often enough that it's worth carrying Bank of England notes for London specifically."
