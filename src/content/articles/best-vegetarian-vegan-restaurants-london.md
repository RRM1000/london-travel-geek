...
tags: [restaurants, vegan restaurants, vegetarian restaurants, plant-based, dining]
draft: false
faq:
  - q: "What is the best vegan restaurant in London?"
    a: "Plates in Shoreditch, which in 2025 became the first fully vegan restaurant in Britain to win a Michelin star. It is a tasting menu, it is expensive, and tables go quickly. For the same cooking without the wait, Gauthier Soho is a French fine-dining room that turned entirely vegan in 2021."
  - q: "Where can I eat vegetarian in London cheaply?"
    a: "Drummond Street by Euston. Diwana Bhel Poori House has been there since 1971, is entirely vegetarian, unlicensed so you can bring your own wine, and its lunchtime thali is among the cheapest proper meals in central London. Temple of Seitan does vegan fried chicken at chicken-shop prices."
  - q: "Which London restaurants are fully vegan rather than vegan-friendly?"
    a: "Plates, Gauthier Soho, Mildreds, Tofu Vegan, Club Mexicana, Temple of Seitan and Unity Diner are entirely vegan. The Gate is entirely vegetarian with an extensive vegan menu, and Rasa, Saravanaa Bhavan, Horn OK Please and Diwana are entirely vegetarian."
  - q: "Is Indian food the best value for vegetarians in London?"
    a: "Yes, comfortably. South Indian and Gujarati cooking is vegetarian by tradition rather than by adaptation, so it is neither a compromise nor a premium. Rasa, Saravanaa Bhavan, Diwana and the Borough Market stalls all come in well under £20."
  - q: "Do I need to book vegan restaurants in London?"
...
<details class="restaurant-map-shell" open>
  <summary>
    <span>Map of the best vegetarian and vegan restaurants in London</span>
  </summary>
  <div class="restaurant-map" data-restaurant-map="vegetarian-london" role="region" aria-label="Interactive map of the best vegetarian and vegan restaurants in London">
  ...
  <div class="restaurant-map-legend" aria-label="Map key">
    ...
    <span><i class="restaurant-map-key restaurant-map-key--streetfood" aria-hidden="true"></i> Market stall & counter</span>
  </div>
  <noscript>
...
Across several floors of a Soho townhouse, so it feels like eating in a private house.
...
Sites in Soho, Camden, Covent Garden, King's Cross and Victoria. Soho is the original. It does not take bookings at every site — check before travelling.
...
Padrón peppers with smoky peanut chilli oil, turmeric milk bread with apricot harissa butter, and cauliflower hummus with pickled mango dressing. It is the Mildreds kitchen given a lighter, more seasonal brief.
...
High-ceilinged studio space in Hammersmith, with further sites in Islington and Marylebone.
...
Cheaper than almost anything else on this page and better than most of it.
...
The room is papered floor to ceiling with hand-made posters arguing the case for vegetarianism, which is part of the experience rather than incidental to it.
...
Loud, intense food that never reads as a compromise. The **crispy sweet and sour seaweed toast** is the dish that made its name and it is still the thing to order.
...
It won at the **Fact. Dining Awards London in 2025**, judged against Caribbean kitchens generally rather than vegan ones — which is the harder comparison and the reason it is here. Small plates £10–12, larger plates around £20.
...
Shojin-influenced rather than a Western vegan menu with Japanese dishes bolted on, which is a genuinely different thing.
...
Opinion divides on the base: it is a soft, wet-centred Neapolitan, so if you want a crust that holds a slice flat this is not it. Order it folded, the way Naples intends.
...
Not a substitution menu: most dishes are traditionally vegetable-based Chinese cooking rather than meat imitations. Further sites in Spitalfields and Marylebone.
