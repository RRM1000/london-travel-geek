...
area:
  ...
  budget: "££"
  bestDay: "Friday or Saturday; Rye Lane market is busiest on Saturdays"
  bestFor:
    - Rooftop bars
    - Cheap eating
    - Independent shops
  ...
  nearestStations:
    - name: "Peckham Rye"
      lines: ["Overground", "Thameslink", "Southeastern"]
  ...
  nearby:
    - name: "Bermondsey"
      ...
      minutes: 20
      note: "North for Maltby Street and the Bermondsey Beer Mile."
    - name: "Greenwich"
      slug: "greenwich-area-guide"
      minutes: 25
      note: "East on the Overground for the river and the Observatory."
    - name: "Battersea"
      slug: "battersea-area-guide"
      minutes: 30
      note: "West on the Overground for the Power Station."
faq:
...
Peckham has its own share of the commemorative plaques marking where notable people lived or worked. [Browse them on the map](/plaques/?area=peckham).
...
2. **Frank's Cafe** — A bar on the top deck of a multi-storey car park with an unobstructed view north to the City. Seasonal, roughly late spring to early autumn.
...
4. **Peckham Levels** — Another converted car park, this time seven floors of studios, food traders and bars. Open year round, unlike Frank's.
...
### Rye Lane
The spine and the market. Loud, crowded and the least gentrified part of the area.

### Copeland Park and the Bussey Building
Off the east side of Rye Lane. The nightlife cluster — bars, studios and the rooftop.

### Bellenden Road
West of Rye Lane and a complete contrast: quiet, low-rise, independent shops and the sit-down restaurants.

### Peckham Road
North towards Camberwell, with the South London Gallery on it.
