...
heroImageCredit: "Change C.C"
heroImageSource: "https://www.pexels.com/photo/assorted-dim-sum-in-bamboo-steamers-32860322/"
...
tags: [restaurants, dim sum, Chinese restaurants, Chinatown, dining]
draft: false
faq:
  - q: "Where is the best dim sum in London?"
    a: "Royal China on Baker Street is the benchmark, running weekend dim sum at enormous volume. A. Wong in Victoria is the only two-Michelin-starred Chinese restaurant in Europe and its dim sum lunch is much cheaper than dinner. Tao Tao Ju in Chinatown makes it fresh on site each day."
  - q: "What time is dim sum served in London?"
    a: "Traditionally lunch, roughly 11am to 5pm, and most halls stop then. Yauatcha in Soho and Dragon Castle at Elephant and Castle both serve all day, which makes them the answer for an evening."
...
<details class="restaurant-map-shell" open>
  <summary>
    <span>Map of the best dim sum in London</span>
  </summary>
  <div class="restaurant-map" data-restaurant-map="dim-sum-london" role="region" aria-label="Interactive map of the best dim sum in London">
...
**All-day dim sum** with a patisserie counter downstairs, from the Hakkasan founder. It held a Michelin star for four years and is the answer when you want dim sum at 8pm.
