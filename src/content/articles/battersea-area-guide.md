...
seoTitle: "Battersea Guide: Power Station, Lift 109 & Battersea Park"
description: "A complete Battersea guide: inside the restored Power Station, the Lift 109 chimney ride, Battersea Park and the Peace Pagoda, and the new Tube link."
...
area:
  name: "Battersea"
  zone: "1"
  vibe: "A rebuilt industrial landmark with a very good park next door"
  walkability: 4
  timeNeeded: "Half a day"
  budget: "££"
  bestDay: "Weekdays are calmer; the park is best on a clear weekend morning"
  bestFor:
    - Architecture
    - Park walks
  ...
  nearby:
    - name: "Chelsea"
      ...
      minutes: 15
      note: "North across Albert Bridge for King's Road, the Physic Garden and Cheyne Walk."
    - name: "Westminster"
      slug: "westminster-area-guide"
      minutes: 25
      note: "North-east along the river, or two stops on the Northern line."
    - name: "South Kensington"
      slug: "south-kensington-area-guide"
      minutes: 30
      note: "North across the river for the museum quarter."
    - name: "South Bank"
...
faq:
  - q: "Can you go inside Battersea Power Station?"
    a: "Yes. It reopened to the public in October 2022 after a long restoration and is now free to enter as a shopping and dining destination. The two turbine halls are open — Turbine Hall A restored in 1930s art deco, Turbine Hall B in 1950s style. Only Lift 109 up the chimney is ticketed."
  - q: "What is Lift 109?"
    a: "A glass lift that rises 109 metres up inside the north-west chimney of the Power Station, opening out at the top for a 360-degree view over London. It is ticketed and timed, and worth booking ahead at weekends. The ride itself is short — you are paying for the view and the novelty of standing inside a chimney."
  - q: "How do I get to Battersea Power Station by Tube?"
    a: "The Northern line was extended to Battersea Power Station in September 2021, with an intermediate stop at Nine Elms. It runs on the Charing Cross branch, so check the front of the train. Journey time is about five minutes from Victoria via a change, or fifteen from Tottenham Court Road direct."
  - q: "Is Battersea Park worth visiting?"
...
2. **Lift 109** — A glass lift 109 metres up inside the north-west chimney, opening at the top for a 360-degree view. Ticketed and timed; book ahead at weekends.
...
5. **Albert Bridge** — Cast-iron, painted pink and green, lit by 4,000 bulbs at night, and still signed asking troops to break step. Best seen from the park side after dark.
...
The restored building, the turbine halls, and the new pedestrian street running south from it.

### Circus West Village
The first phase of the development, along the railway arches. Bars and restaurants with outdoor seating.

### Nine Elms and the riverside
East towards Vauxhall. The US Embassy, new towers, and a continuous Thames Path.

### Battersea Park
West. The boating lake, the pagoda, the zoo and the bandstand.
...
| **A full day** | Add Lift 109 and the walk over Albert Bridge into Chelsea |
...
**Book ahead:** Lift 109 is timed entry and sells out at weekends.
...
2. **Assuming you have to pay to get in.** The Power Station and both turbine halls are free. Only Lift 109 charges.
3. **Turning up for Lift 109 without booking.** Timed entry, and weekends sell out.
