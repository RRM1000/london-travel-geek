...
area:
  name: "the South Bank"
  zone: "1"
  vibe: "Open, riverside and the most reliably pleasant walk in London"
  walkability: 5
  ...
  nearestStations:
    - name: "Waterloo"
      lines: ["Jubilee", "Northern", "Bakerloo", "National Rail"]
    - name: "Southwark"
      lines: ["Jubilee"]
    - name: "London Bridge"
  ...
  nearby:
    - name: "Westminster"
      ...
      minutes: 10
      note: "Across Westminster Bridge for Big Ben, the Abbey and Whitehall."
    - name: "The City of London"
      slug: "city-of-london-area-guide"
      minutes: 5
      note: "Over the Millennium Bridge from Tate Modern, straight to St Paul's."
    - name: "Covent Garden"
      slug: "covent-garden-area-guide"
      minutes: 15
      note: "North over Waterloo Bridge, which has the best view in London."
    - name: "Shoreditch"
      slug: "shoreditch-area-guide"
      minutes: 30
      note: "North-east past Tower Bridge for markets, street art and evening bars."
faq:
  - q: "How long is the South Bank walk?"
    a: "From the London Eye to Tower Bridge is about 3.5 km and takes roughly 45 minutes at a steady pace, or half a day with stops. It is entirely flat, fully paved and step-free the whole way, with the only bridges being optional crossings."
...
The South Bank has its own share of the commemorative plaques marking where notable people lived or worked. [Browse them on the map](/plaques/?area=south-bank).
