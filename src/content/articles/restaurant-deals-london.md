...
draft: false
faq:
  - q: "What is a set lunch menu?"
    a: "A fixed-price menu with a limited choice of dishes, served at lunchtime and usually on weekdays only. Restaurants run them because a half-empty dining room costs the same to staff as a full one, so the kitchen is the same and the price is often less than half what the same food costs at dinner."
  - q: "Which London restaurant has the best-value set lunch?"
    a: "For the size of the saving, Chez Bruce in Wandsworth — £40.50 for two courses against £98.50 for three at dinner. For an outright cheap lunch, Franco Manca at £12.50 for a pizza and a soft drink, or Brasserie Zédel at £16.95 for two courses."
  - q: "Do I need to book a set lunch?"
    a: "Usually yes, and for the fine dining ones well in advance. Set menus often carry table-size limits — Quo Vadis caps at four, Hawksmoor at seven — and some, like Hoppers and Som Saa, require the whole table to take the set menu."
  - q: "Are set lunch menus available at weekends?"
...
**A limited choice.** Typically two or three options per course. That is the trade — you are eating what the kitchen wants to cook that week, not off the full carte.

**Time windows are tight.** Most run from midday to somewhere between 2.15pm and 6pm. Some, like Restaurant Gordon Ramsay's 12:00–13:30, are very narrow indeed.

**Sometimes the whole table has to take it.** Hoppers and Som Saa both require it, and several cap the table size — Quo Vadis at four, Hawksmoor at seven.

---

## The biggest savings: fine dining at lunch

This is where set lunch stops being a discount and becomes a different proposition entirely — Michelin-starred cooking at a price you would pay for a mid-range dinner.

| Restaurant | Set lunch | Dinner instead | When |
| --- | --- | --- | --- |
| **Chez Bruce**, Wandsworth | **£40.50 / 2 courses, £48.50 / 3** | £98.50 for three | Tue–Fri lunch |
| **Galvin La Chapelle**, Spitalfields ★ | £49 / 2, £55 / 3 | £34–£50 per main à la carte | Lunch, not Sunday |
| **Kitchen W8**, Kensington ★ | £49.50 / 3 courses | — | Lunch Mon–Sat, and 6–6.15pm sitting |
| **Trinity**, Clapham ★ | £105 / 4 courses | £155 for the same four courses | Daily 12.15–2pm |
| **Restaurant Gordon Ramsay**, Chelsea ★★★ | £125 / 3 courses | £210 Menu Prestige | Tue–Sat 12–1.30pm |

**Chez Bruce is the standout.** The "Brucie Bonus" is £40.50 for two courses when the same kitchen charges £98.50 for three in the evening — under half price, at a restaurant that has held a Michelin star for over twenty years.

**Trinity and Gordon Ramsay are not cheap in absolute terms**, but both are roughly a third off the same format at dinner. Whether that reads as a bargain depends entirely on your baseline.
...
## Reliable mid-range set lunches

| Restaurant | Deal | When |
| --- | --- | --- |
| **Brasserie Zédel**, Piccadilly | £16.95 / 2, £19.95 / 3 | Lunch **and** dinner |
| **Bocca di Lupo**, Soho | £18 starter + main, £26 with dessert | Mon–Fri until 6.30pm |
| **Boulevard Brasserie**, Covent Garden | £21.95 starter + main, £26.90 with dessert | Daily 12–6.30pm |
| **The Delaunay**, Aldwych | £23.50 / 2, £27.50 / 3 | Daily from 11.30am |
| **Balthazar**, Covent Garden | £25.50 set menu | Mon–Fri all day |
...
| Chain | Deal | When |
| --- | --- | --- |
| **Franco Manca** | £12.50 one course — pizza plus a soft drink. £15 two courses | Mon–Fri 12–4pm |
| **Dishoom** | £16pp "Swift Vitality", £20pp "Prompt Replenishment", to share between two | Mon–Fri 12–5pm |
| **Hawksmoor** | £20 / 1, £25 / 2, £30 / 3 courses. Max seven | Mon–Thu 12–5.45pm, Fri–Sat 12–5pm |
| **Côte Brasserie** | £22.50–£23.50 / 2, £26.50–£27.50 / 3 — varies by branch | Mon–Fri from 11.30am |
| **Hoppers** | £22pp "Lunch Plate", whole table | Mon–Fri 12–3pm |

**Hawksmoor is the one to know.** £20 buys a course at a steakhouse where dinner runs to three figures, and it runs on Saturdays as well — rare for a set lunch.
...
<div data-gyg-href="https://widget.getyourguide.com/default/activities.frame" data-gyg-locale-code="en-US" data-gyg-widget="activities" data-gyg-number-of-items="3" data-gyg-cmp="restaurant-deals-london-attraction-passes" data-gyg-partner-id="WWP7I0R" data-gyg-tour-ids="26207,102239,193412"><span>Powered by <a target="_blank" rel="sponsored" href="https://www.getyourguide.com/london-l57/">GetYourGuide</a></span></div>
...
- 🥩 **[The Best Steak Restaurants in London](/articles/best-steak-restaurants-london/)**
- 🎭 **[London Theatre: Choosing a Show and Paying Less](/articles/london-theatre-guide/)**

*All prices and times read off the restaurants' own sites and menu PDFs on 31 August 2026.*
