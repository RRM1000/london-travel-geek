...
area:
  name: "Bermondsey"
  zone: "1–2"
  vibe: "Railway arches, warehouse conversions and a lot of breweries"
  walkability: 5
  timeNeeded: "Half a day"
  budget: "££"
  bestDay: "Saturday for the market and the Beer Mile at full strength"
  bestFor:
    - Food markets
    - Breweries
    - Galleries
  ...
  nearestStations:
    ...
    - name: "Bermondsey"
      lines: ["Jubilee"]
    - name: "Tower Bridge"
      lines: ["National Rail (London Bridge, 10 min walk)"]
  nearby:
    - name: "South Bank"
      slug: "south-bank-area-guide"
      minutes: 10
      note: "West along the river for Borough Market, Tate Modern and the full South Bank walk."
    - name: "The City of London"
      slug: "city-of-london-area-guide"
      minutes: 15
      note: "North over Tower Bridge for St Paul's and the Tower."
    - name: "Wapping"
      slug: "wapping-area-guide"
      minutes: 15
      note: "North under the river on the Overground for the old riverside pubs."
    - name: "Greenwich"
      slug: "greenwich-area-guide"
      minutes: 25
      note: "East by river boat or Jubilee line and DLR for the Observatory."
faq:
  ...
  - q: "What is the Bermondsey Antiques Market?"
    a: "A long-established antiques market on Bermondsey Square, held on Friday mornings and starting very early — traders are there from around 04:00 and the serious dealing is done by 08:00. It is a working trade market rather than a visitor attraction, which is much of its interest."
  - q: "Is Bermondsey the same as Borough?"
    a: "No, though they run into each other. Borough is immediately west, around Borough Market and London Bridge station. Bermondsey is east of that, centred on Bermondsey Street and the railway arches. They are a ten-minute walk apart and easy to do together."
heroImage: ../../assets/articles/bermondsey-area-guide/bermondsey-street-bermondsey-geograph-org-uk-3953124.jpg
heroImageAlt: "Georgian houses and painted shopfronts on Bermondsey Street with the Shard rising behind"
heroImageCredit: "Chris Whippet"
heroImageSource: https://commons.wikimedia.org/wiki/File:Bermondsey_Street,_Bermondsey_-_geograph.org.uk_-_3953124.jpg
