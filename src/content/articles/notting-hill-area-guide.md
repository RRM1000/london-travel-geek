...
area:
  name: "Notting Hill"
  zone: "1–2"
  vibe: "Bohemian, village-like and relentlessly photogenic"
  walkability: 5
  ...
  nearestStations:
    - name: "Notting Hill Gate"
      lines: ["Central", "District", "Circle"]
    - name: "Ladbroke Grove"
      lines: ["Circle", "Hammersmith & City"]
    - name: "Westbourne Park"
      lines: ["Circle", "Hammersmith & City"]
  nearby:
    - name: "Paddington and Little Venice"
      slug: "paddington-area-guide"
      minutes: 25
      note: "Follow the canal east from Westbourne Park to the Little Venice basin and its narrowboat cafes."
    - name: "Holland Park and Kensington"
      slug: "kensington-area-guide"
      minutes: 15
      note: "South down Portland Road for the quietest park in west London and its Japanese garden."
    - name: "Kensington Gardens"
      slug: "kensington-area-guide"
      minutes: 20
      note: "East along Bayswater Road for Kensington Palace and the Serpentine galleries."
    - name: "Shepherd's Bush and Westfield"
      minutes: 30
      note: "Two stops west on the Central line when the weather turns and you want cover."
faq:
...
<div data-gyg-href="https://widget.getyourguide.com/default/activities.frame" data-gyg-locale-code="en-US" data-gyg-widget="activities" data-gyg-number-of-items="3" data-gyg-cmp="notting-hill-area-guide-london-classics" data-gyg-partner-id="WWP7I0R" data-gyg-tour-ids="170451,21253,399163"><span>Powered by <a target="_blank" rel="sponsored" href="https://www.getyourguide.com/london-l57/">GetYourGuide</a></span></div>
