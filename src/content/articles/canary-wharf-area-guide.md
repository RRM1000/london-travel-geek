...
area:
  ...
  nearestStations:
    - name: "Canary Wharf"
      lines: ["Elizabeth line", "Jubilee", "DLR"]
  ...
  nearby:
    - name: "Greenwich"
      ...
      minutes: 20
      note: "South by DLR, or walk the Greenwich Foot Tunnel under the river from Island Gardens."
    - name: "The City of London"
      slug: "city-of-london-area-guide"
      minutes: 15
      note: "West by DLR to Bank, or six minutes on the Elizabeth line to Liverpool Street."
    - name: "Shoreditch"
      slug: "shoreditch-area-guide"
      minutes: 15
      note: "Elizabeth line to Liverpool Street, then ten minutes north on foot."
    - name: "The O2 and North Greenwich"
      minutes: 15
