...
faq:
  - q: "What is the best Indian restaurant in London?"
    a: "Gymkhana, on the evidence. It holds two Michelin stars — the only Indian kitchen in Britain that does — it is a British Indian Good Food Guide London Icon, and eleven independent sources name it, more than any other Indian restaurant in the city. Trishna is the easier answer for most people: one star, half the price, and named by nine sources."
  - q: "How far ahead should I book?"
    a: "Gymkhana takes months. BiBi, Veeraswamy, Jamavar, Benares, Tamarind, Quilon, Oudh 1722, Darjeeling Express and Jikoni all want weeks. Dishoom takes any party size before 6pm but only groups of six or more after that, and Shree Krishna Vada Pav and every market stall here are walk-in only."
  - q: "Where do I eat Indian food in London cheaply?"
    a: "Shree Krishna Vada Pav in Fitzrovia and Rasa in Stoke Newington both come in under £20 a head, as do the Borough Market and Seven Dials stalls. All are walk-in."
  - q: "Is Brick Lane still worth visiting for a curry?"
    a: "For the street and its history, yes. For the food, the consensus among London food writers has moved east to Whitechapel and out to Southall, Tooting and East Ham. Note that Brick Lane's kitchens are largely Bangladeshi and Whitechapel's are Pakistani — both are their own traditions rather than sub-types of Indian cooking."
...
> Nothing here is ranked on one visit. This pass reads **22 sources carrying 242 citations** across **103 named restaurants** — the judged awards (Michelin, the Asian Curry Awards, the British Indian Good Food Guide, the Good Food Guide), the editorial mastheads (Time Out, The Infatuation, Olive, Eater, SquareMeal) and the year's major London Indian food videos. **43 restaurants are named by two or more independent sources; 42 carry a dated award.**
> **The known weakness in this topic:** no community tier. Reddit and forum threads are where Londoners actually argue about curry, and none are recorded here yet — so this ranking leans on critics and awards, which favour central London and the top of the price range.
