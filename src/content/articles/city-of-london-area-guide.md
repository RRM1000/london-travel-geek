...
area:
  ...
  zone: "1"
  vibe: "Roman street plan under glass towers, and empty at weekends"
  walkability: 5
  ...
  nearestStations:
    - name: "St Paul's"
      lines: ["Central"]
    - name: "Bank"
      lines: ["Central", "Northern", "Waterloo & City", "DLR"]
  ...
  nearby:
    - name: "Shoreditch"
      ...
      minutes: 15
      note: "North past Liverpool Street for markets, street art and somewhere open in the evening."
    - name: "South Bank"
      slug: "south-bank-area-guide"
      minutes: 5
      note: "Straight over the Millennium Bridge from St Paul's to Tate Modern."
    - name: "Bloomsbury"
      slug: "bloomsbury-area-guide"
      minutes: 20
      note: "West along Theobald's Road for the British Museum and the garden squares."
    - name: "Canary Wharf"
      slug: "canary-wharf-area-guide"
      minutes: 15
      note: "East by DLR from Bank or Tower Gateway — walking is not practical."
faq:
  - q: "Is the City of London the same as London?"
    a: "No. The City of London is a separate square-mile authority at the historic centre, with its own police force, its own Lord Mayor and around 8,000 residents. It is the original Roman and medieval city. Greater London — the 32 boroughs around it — grew up later and is what people usually mean by London."
...
<div data-gyg-href="https://widget.getyourguide.com/default/activities.frame" data-gyg-locale-code="en-US" data-gyg-widget="activities" data-gyg-number-of-items="3" data-gyg-cmp="city-of-london-area-guide-walking-tours" data-gyg-partner-id="WWP7I0R" data-gyg-tour-ids="359535,765419,1242361"><span>Powered by <a target="_blank" rel="sponsored" href="https://www.getyourguide.com/london-l57/">GetYourGuide</a></span></div>
