...
faq:
  ...
  - q: "Which London venues turn away stag groups?"
    a: "Cirque le Soir's door policy states that groups must be mixed and that all-male groups may be turned away. Swift refuses stag parties in writing at Soho, Borough and Shoreditch, runs a 21-and-over door and will not seat a booking of more than six in Soho. Nightjar takes groups of up to 20 but only from Sunday to Thursday."
  - q: "Can you still go karting in London for a stag do?"
    a: "Not at Capital Karts Barking, which was the default answer for a decade — the operator's own site now lists only Star City in Birmingham. The London alternatives that publish prices are F1 Arcade at St Paul's, where the Sprint Social is £25 a head for three hours, and Gravity MAX in Wandsworth at £15.25 a head for karting or £28.50 for its three-activity pass."
  - q: "What will get a stag group refused at the door?"
    a: "Sportswear, mostly. Ministry of Sound refuses tracksuits, sportswear, caps, football shirts and face coverings. Tape refuses designer tracksuits, sliders and everyday trainers. Bat & Ball bans tracksuit bottoms, gym wear, hats and work boots after 7pm. Fairgame and Tape both demand physical photo ID and will not accept a picture of one."
  - q: "How far ahead do you need to book a stag do in London?"
    a: "Two to four weeks covers almost everything for a Saturday. The exceptions are Swingers, which releases tickets two months ahead and sells out its evening slots, and any restaurant table for twelve, which wants three to four weeks. Flight Club needs booking early because it will not take fewer than six after 4pm from Wednesday to Saturday."
  - q: "What works if half the group is not drinking?"
...
*Every price, group limit and door policy below was read off the operator's own website on 3 September 2026.*

> 💡 **The Short Version:** **Swift refuses stag parties at all three of its bars** and asks you to leave the replica kit at home. **Fairgame is 18-plus at every hour it opens and wants physical ID, not a photo of one.** **F1 Arcade's Sprint Social is £25 a head for three hours** of tournament racing with food. A **private Thames Rockets speedboat for twelve works out at £57.92 each**, under the £59.95 public ticket. And **Flight Club will not take a booking of fewer than six after 4pm from Wednesday to Saturday.**
...
| --- | --- | --- | --- | --- |
| Bowling, Bloomsbury Lanes | £7.50 (lane of 6, off-peak) | 60 mins | 6 a lane | 2 weeks |
| Axe throwing, Rocket Room, Leicester Sq | £8 off-peak, £12 peak | 60 mins | Hire to 120 | 2 weeks |
| Mini golf, Puttshack Bank | £9.50 off-peak, £14 peak | 30 mins | Max 12 online | 3 weeks |
| Bowling, Tenpin Acton | £9.95 a game | 60 mins for 6 | 6 a lane | 1 week |
| Darts, Flight Club | £10 | 90 mins | **Min 6** after 4pm Wed–Sat | 4 weeks |
| Fairground games, Fairgame Canary Wharf | £15 off-peak, £19 prime | 75 mins | 1 to 15 online | 3 weeks |
| F1 simulators, F1 Arcade St Paul's | £25 (Sprint Social) | 3 hours | 3 to 5 priced as a group | 3 weeks |
| Escape room, Mission: Breakout, Camden | From £28 | 60 mins | 3–6 a room, 18 max | 4 weeks |
| Treasure hunt, Race Across The World | £35 | 3 hours | Teams of 2–8 | 3 weeks |
| Bottomless brunch, Electric Shuffle | £38 | 2 hours | 2 to 32 | 3 weeks |
| Prohibition bar, Moonshine Saloon | £38 + £3.04 fee | 105 mins | No max, 30+ via events | 3 weeks |
| Karaoke package, BAM Victoria | £45 (£62.50 with food) | 2 hours | 4 to 40 | 4 weeks |
| THE CUBE, Canary Wharf | £48.65–£57.69 | 90–120 mins | Played in fours | 4 weeks |
...
**Rocket Room on the second floor of Market Place, Leicester Square, publishes an actual price list**, which almost nothing in this category manages. **Axe throwing is £12 a person an hour, £8 off-peak.** Interactive darts is £10 and £8, shuffleboard £20 an hour for the board (£18 off-peak) and beer pong a flat £30 an hour whenever you play.

**Two rules will stop you at the door: closed-toe shoes are compulsory for axes, and tracksuits, gym wear and sandals are refused outright.** Axe throwing is 18-plus at every hour, everywhere in London. Nothing is refunded inside seven days.

### Darts, shuffleboard and the rest of the format

**Flight Club invented social darts and carries the rule that ruins plans: a minimum of six people to book after 4pm from Wednesday to Saturday** — four on Monday and Tuesday, six every day through December. Play starts at £10 a head, sessions are **fixed at 90 minutes and cannot be extended**, and groups over 12 get two oches. It is 18-plus after 5pm Sunday to Friday and all day Saturday.
...
**Rowans in Finsbury Park is £8.60 a game in the daytime and £10.80 on a Friday or Saturday evening**, plus admission of £1 that becomes **£5 after 7pm at weekends**, and it stays open to 2.30am. Read the age rule first: **after 7pm on Friday and Saturday it is over-21s only, on photo ID.** **Tenpin is £9.95 a game online**, with **50% off on Tuesdays**.

### Games you play rather than watch

**Mission: Breakout in Camden is from £28 a player**, and the room is a real disused Underground station — South Kentish Town, shut since 1924 — not a set. Three to six players a game, three games running at once, so **eighteen people is the ceiling**.

**THE CUBE at Canary Wharf is £48.65 to £57.69 a head**, the priciest game here, and **it is played in fours in a 2v2 format** — so twelve splits into three pods and you are pooled with strangers if the numbers do not divide.

**Race Across The World: The Experience is £35 an adult with no booking fee**, teams of two to eight playing privately across the Square Mile over WhatsApp — three checkpoints, a virtual budget, **no public transport allowed**, five kilometres on foot. It works on a hangover.
...
<div data-gyg-href="https://widget.getyourguide.com/default/activities.frame" data-gyg-locale-code="en-US" data-gyg-widget="activities" data-gyg-number-of-items="3" data-gyg-cmp="stag-do-london-family-favourites" data-gyg-partner-id="WWP7I0R" data-gyg-tour-ids="174429,174549,174546"><span>Powered by <a target="_blank" rel="sponsored" href="https://www.getyourguide.com/london-l57/">GetYourGuide</a></span></div>

## The evening

### The doors that will not open

**Swift refuses stag parties in writing at all three London bars** — Soho, Borough and Shoreditch. The line is identical on every page: *"Sorry, but we are unable to accommodate any stag or hen parties."* Alongside it: **"Swift operates a 21 and over policy at all our venues"** and **"Please leave your Arsenal replica kit at home."** Swift Soho will not take a booking greater than six.

**Cirque le Soir on Ganton Street states that groups must be mixed and that all-male groups may be turned away.** It is 19-plus on Monday and Wednesday and 20-plus at weekends, publishes no entry price or minimum spend, and takes tables only by phone or WhatsApp.

**Nightjar in Shoreditch takes groups of up to 20 — Sunday to Thursday only**, with a pre-order and a minimum spend. No weekend group booking exists there at all.
...
**One building, not twelve hotel rooms.** Read the group terms before the rate, because they are where the money goes.
...
> ⚠️ **A whole house on a short let is harder than it looks.** Greater London caps short-term letting at **90 nights a calendar year** under the Deregulation Act 2015, and **Airbnb automatically limits entire-home London listings to 90 nights** without planning permission. Airbnb also bans parties and "disruptive gatherings, regardless of size", and **blocks reservations it judges higher risk**. A booking for twelve men declined without explanation is usually that, not bad luck.
...
**The £414 two-night weekend.** A private Thames Rockets charter (£57.92), THE CUBE on a Friday (£48.65), the Murdér Express group carriage (£60), £50 of drinks, £17.80 of travel and £180 a head for two nights in an apartment. **Total £414.37** — and the bed is the biggest single line, not the activities.

**On splitting it.** Nothing here takes a group payment as standard, so the organiser fronts the money unless they collect first. Collect at the point of booking and treat every deposit as spent: Clink's 20% is non-refundable, Rocket Room refunds nothing inside seven days, and **Boom Battle Bar charges £10 a head if you cancel inside 24 hours or arrive more than fifteen minutes late** — which, with twelve people, happens.

---

## Package company or do it yourself

**StagWeb sells London weekends from £189 a head.** *The Legend* is £189 for two nights with a casino night, axe throwing and a cocktail experience. *The Boss* is £209 with a stadium tour, a football session and nightclub entry. *The GOAT* is £285 with go karting, a comedy club and a Bavarian feast. The deposit is £10 a head, the group pays individually.
...
<div data-gyg-href="https://widget.getyourguide.com/default/activities.frame" data-gyg-locale-code="en-US" data-gyg-widget="activities" data-gyg-number-of-items="3" data-gyg-cmp="stag-do-london-london-classics" data-gyg-partner-id="WWP7I0R" data-gyg-tour-ids="170451,21253,399163"><span>Powered by <a target="_blank" rel="sponsored" href="https://www.getyourguide.com/london-l57/">GetYourGuide</a></span></div>
...
* **Dump the bags first.** Stasher is from £1.49 a bag a day with cover to £10,000 — 17 points at Euston, 28 around King's Cross St Pancras, 27 at Paddington and 26 at Liverpool Street, more than 70 of them open around the clock.
