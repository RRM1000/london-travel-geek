...
area:
  name: "Islington"
  zone: "1–2"
  vibe: "Georgian terraces and a mile of restaurants, theatres and antique shops"
  walkability: 5
  timeNeeded: "Half a day, or an evening"
  budget: "££"
  bestDay: "Wednesday or Saturday for the Camden Passage antique market"
  bestFor:
    - Dining
  ...
  nearestStations:
    ...
    - name: "Highbury & Islington"
      lines: ["Victoria", "London Overground", "National Rail"]
    - name: "Essex Road"
      lines: ["National Rail"]
  nearby:
    - name: "King's Cross"
      ...
      minutes: 20
      note: "West for Coal Drops Yard, the British Library and the canal towpath."
    - name: "Shoreditch"
      slug: "shoreditch-area-guide"
      minutes: 25
      note: "South-east down City Road for markets, street art and late bars."
    - name: "Camden"
      slug: "camden-area-guide"
      minutes: 25
      note: "West along the canal, or one stop on the Northern line."
    - name: "Hackney"
      slug: "hackney-area-guide"
      minutes: 20
      note: "East on the Overground from Highbury & Islington for Broadway Market and London Fields."
faq:
  - q: "What is Camden Passage and is it the same as Camden Market?"
    a: "No, and they are not near each other. Camden Passage is a narrow pedestrian lane off Upper Street in Islington, lined with antique shops and arcades. Camden Market is two miles north-west in Camden Town. The antique market in Camden Passage runs on Wednesdays and Saturdays, with the shops open most days."
  ...
  - q: "Is the Union Chapel still a working church?"
    a: "Yes, both. It is an active Congregational church and one of London's most atmospheric music venues, with concerts held in the Gothic octagonal chapel itself. It also runs a night shelter. Gigs there are seated in the original pews."
heroImage: ../../assets/articles/islington-area-guide/100-104-islington-high-street-islington-june-2022-02.jpg
heroImageAlt: "Georgian shopfronts and independent businesses on Islington High Street near the Angel"
heroImageCredit: "No Swan So Fine"
heroImageSource: https://commons.wikimedia.org/wiki/File:100-104_Islington_High_Street,_Islington,_June_2022_02.jpg
