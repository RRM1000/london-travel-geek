---
title: "How to Get to Tottenham Hotspur Stadium: Parking, Trains and Getting Home"
seoTitle: "Tottenham Hotspur Stadium Travel 2026: How to Get Home"
...
tags: [Tottenham Hotspur, Tottenham Hotspur Stadium, NFL London Games, NFL, White Hart Lane, parking, getting around, football, concerts]
draft: false
faq:
  - q: "Which station is best for Tottenham Hotspur Stadium?"
    a: "White Hart Lane, for almost everyone. It's a 5-minute, roughly 500-step walk from the stadium's west side, it's step-free, and it's what the club itself recommends for home and away fans alike. Northumberland Park is a 10-minute walk in from the east and takes the overflow. Tottenham Hale (25 minutes) and Seven Sisters (30 minutes) are the Victoria line options for anyone coming from central London, but neither is on the doorstep."
  - q: "Is White Hart Lane station on the London Overground?"
    a: "Yes, on the Weaver line, with direct trains to and from Liverpool Street plus onward services to Enfield Town or Cheshunt. Northumberland Park, the second-closest station, is not on the Overground at all — it's served only by Greater Anglia. Don't assume the two closest stations are on the same network; they're run by different operators with different tickets and different apps to check for disruption."
  - q: "Can you park at Tottenham Hotspur Stadium?"
    a: "Not if you're a general admission fan — there is no public car park at the ground. The only on-site parking is 74 accessible bays in the basement, booked in advance through the Disability Access Scheme for Blue Badge holders. Everyone else is expected to arrive by train, bus, or coach."
  - q: "What happens if you park on the street near the stadium on a matchday?"
    a: "Haringey runs additional controls across seven controlled parking zones — Northumberland Park West, The Hale, Tottenham Hale North, Tottenham Event Day, Tower Gardens, White Hart Lane and Willoughby Lane — for any event expected to draw more than 10,000 people. Hours are 5pm to 8.30pm on weekdays and noon to 8pm on weekends and bank holidays. Parking without a valid permit in a suspended or resident's bay is a higher-band penalty charge of £160, cut to £80 if you pay within 14 days."
  ...
  - q: "What's the bag policy at Tottenham Hotspur Stadium?"
    a: "Personal bags must be A4 size or smaller (21cm × 30cm). There's no bag drop at the ground, so anything bigger has to stay at your hotel or in left luggage before you travel. A clear bag up to 30cm × 30cm is allowed as an alternative, and there's a medical exemption form for anyone who needs to bring bulkier equipment."
  - q: "Is Tottenham Hotspur Stadium accessible for wheelchair users?"
    a: "Yes — it was built with over 250 wheelchair bays and more than 500 additional accessible seats, five lifts running the full height of the concourse, 66 accessible toilets and a dedicated Sensory Suite in the North Stand for supporters who need a lower-stimulation space. White Hart Lane and Northumberland Park stations both have step-free access; Seven Sisters does not."
  - q: "Is it worth staying near Tottenham Hotspur Stadium on a match night?"
    a: "There isn't really a 'near the stadium' to stay in — no hotels sit close to the ground itself. The closest chain hotel is 25 minutes' walk away at Tottenham Hale. Checking that hotel's own booking engine, a room for the first NFL Sunday in October was £184 to £202 against £143 to £170 for an ordinary Tuesday the same week — a real but modest jump, nothing like the multiples you'd see near Wembley. Staying central and taking the Victoria line out is the simpler option for most visitors."
  - q: "Does Tottenham Hotspur Stadium still have its own brewery?"
    a: "Yes, still current: Beavertown Brewery operates in the South Stand, and its beer is served at the Goal Line Bar, which the club markets as the longest bar in Europe at 65 metres."
  - q: "Can you drink alcohol on the street near the stadium on a matchday?"
    a: "No. Haringey's borough-wide Public Spaces Protection Order bans drinking alcohol in an anti-social manner anywhere in the borough, including Tottenham, and is in force until May 2028. The fixed penalty is £100, rising to a maximum £1,000 if it goes to court and isn't paid."
---
...
<div data-gyg-href="https://widget.getyourguide.com/default/activities.frame" data-gyg-locale-code="en-US" data-gyg-widget="activities" data-gyg-number-of-items="3" data-gyg-cmp="tottenham-hotspur-stadium-travel-guide-tower-of-london-tickets" data-gyg-partner-id="WWP7I0R" data-gyg-q="Tower of London tickets"><span>Powered by <a target="_blank" rel="sponsored" href="https://www.getyourguide.com/london-l57/">GetYourGuide</a></span></div>
...
<div data-gyg-href="https://widget.getyourguide.com/default/activities.frame" data-gyg-locale-code="en-US" data-gyg-widget="activities" data-gyg-number-of-items="3" data-gyg-cmp="tottenham-hotspur-stadium-travel-guide-london-eye-tickets" data-gyg-partner-id="WWP7I0R" data-gyg-q="London Eye tickets"><span>Powered by <a target="_blank" rel="sponsored" href="https://www.getyourguide.com/london-l57/">GetYourGuide</a></span></div>
