...
area:
  name: "Mayfair"
  zone: "1"
  vibe: "Georgian grid, art dealers and the most expensive square in Monopoly"
  walkability: 5
  ...
  nearestStations:
    ...
    - name: "Bond Street"
      lines: ["Elizabeth line", "Central", "Jubilee"]
    - name: "Oxford Circus"
  ...
  nearby:
    - name: "Soho"
      ...
      minutes: 10
      note: "East across Regent Street for Chinatown, Carnaby Street and dinner."
    - name: "Marylebone"
      slug: "marylebone-area-guide"
      minutes: 12
      note: "North across Oxford Street for the village high street and the Wallace Collection."
    - name: "Westminster"
      slug: "westminster-area-guide"
      minutes: 20
      note: "South through Green Park to Buckingham Palace and Whitehall."
    - name: "Covent Garden"
      slug: "covent-garden-area-guide"
      minutes: 15
      note: "East along Piccadilly for the Piazza and the theatres."
faq:
  ...
  - q: "Is Mayfair worth visiting if I am not shopping?"
    a: "Yes, for the architecture and the galleries. It is the best-preserved Georgian grid in central London — laid out from the 1720s — and the density of free commercial art galleries is unmatched anywhere in the city. Shepherd Market in the middle is a genuine surprise: a small, scruffy village of pubs in the most expensive postcode in Britain."
  - q: "What is the Royal Academy Summer Exhibition?"
    a: "An open-submission show held every year since 1769 — the longest-running of its kind in the world. Anyone can submit, and the accepted works hang salon-style, floor to ceiling, alongside Royal Academicians. It runs roughly June to August and is ticketed."
heroImage: "../../assets/articles/mayfair-area-guide/regent-street-quadrant.jpg"
...
<div data-gyg-href="https://widget.getyourguide.com/default/activities.frame" data-gyg-locale-code="en-US" data-gyg-widget="activities" data-gyg-number-of-items="3" data-gyg-cmp="mayfair-area-guide-london-classics" data-gyg-partner-id="WWP7I0R" data-gyg-tour-ids="170451,21253,399163"><span>Powered by <a target="_blank" rel="sponsored" href="https://www.getyourguide.com/london-l57/">GetYourGuide</a></span></div>
