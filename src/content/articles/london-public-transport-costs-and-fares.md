...
tags:
  ...
  - budget travel
draft: false
heroImage: "../../assets/articles/london-underground/oyster-card-reader.jpg"
heroImageAlt: "A yellow Oyster and contactless payment reader on a London Underground ticket gate"
heroImageCredit: "Oxyman"
heroImageSource: "https://commons.wikimedia.org/wiki/File:TfL_Oyster_Card_reader.jpg"
...
This is the price companion to our [complete London transport overview](/articles/getting-around-london-transport-guide/).

## Peak and off-peak times

Peak and off-peak pricing mainly affects the Underground, DLR, London Overground, Elizabeth line and National Rail journeys using pay as you go.

| Fare period | When it applies |
| --- | --- |
| Morning peak | Monday to Friday, **06:30–09:29** |
| Evening peak | Monday to Friday, **16:00–18:59** |
| Off-peak | Monday to Friday before 06:30, 09:30–15:59 and after 19:00 |
| Weekends and public holidays | Off-peak all day |

The time you **touch in at the start** normally determines whether a single rail fare is peak or off-peak.

There are important exceptions:

- Journeys starting outside Zone 1 between 16:00 and 18:59 and ending in Zone 1 are normally charged an off-peak fare.
- On the Elizabeth line Reading extension, the evening contra-peak rule applies more widely to journeys heading towards London.
- It does not apply in the same way on Southeastern high speed, Gatwick Express or Heathrow Express.
- Tube and Elizabeth line journeys to or from Heathrow that start, end or pass through Zone 1 are charged peak fares.

Because the exceptions are journey-specific, check unusual or expensive routes in the [Single Fare Finder](https://tfl.gov.uk/fares/find-fares/single-fare-finder).
...
| Zones travelled | Peak single | Off-peak single |
| --- | ---: | ---: |
| 1 zone | £3.10 | £3.00 |
| 2 zones | £3.60 | £3.10 |
| 3 zones | £3.90 | £3.30 |
...
### Single Fare Finder: check any journey's exact price

The tables above are the standard zonal fares. For a specific journey — particularly one that touches National Rail, an airport, or any of the peak-time exceptions listed earlier — use TfL's **[Single Fare Finder](https://tfl.gov.uk/fares/find-fares/single-fare-finder)**. Enter any two stations and it returns the exact pay-as-you-go single for Oyster and contactless, peak and off-peak, including any Railcard discount loaded on the card. It draws on the same fare data the barriers charge from, so if a figure on this page and the finder ever disagree, trust the finder.

## Daily and weekly caps

A cap limits what you pay for eligible journeys when you keep using the same Oyster card or the same contactless card or device. The TfL day runs from **04:30 to 04:29** the following morning.

| Zones used | Daily cap | Monday–Sunday cap |
| --- | ---: | ---: |
...
| Zones 1–7 | £17.80 peak / £16.30 off-peak | £88.90 |
| Zones 1–8 | £21.00 peak / £16.30 off-peak | £104.90 |
