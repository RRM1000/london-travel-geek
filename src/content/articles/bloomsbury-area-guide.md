...
area:
  name: "Bloomsbury"
  zone: "1"
  vibe: "Academic and leafy, with the calmest streets in central London"
  walkability: 5
  timeNeeded: "Half a day, or a full day with the British Museum"
  budget: "££"
  bestDay: "Weekdays; the British Museum is busiest at weekends"
  bestFor:
    - The British Museum
    - Garden squares
    - Bookshops
  ...
  nearby:
    - name: "King's Cross"
      ...
      minutes: 15
      note: "North for Coal Drops Yard, the British Library and the canal."
    - name: "Covent Garden"
      slug: "covent-garden-area-guide"
      minutes: 12
      note: "South through Holborn for the Piazza and the theatres."
    - name: "Soho"
...
faq:
  ...
  - q: "How do I avoid the crowds at the British Museum?"
    a: "Go at opening on a weekday, and use the **Montague Place** entrance on the north side rather than the main Great Russell Street gate. It is the same museum with a fraction of the queue. Late-opening Friday evenings are also much quieter than weekend afternoons."
  - q: "How long do you need at the British Museum?"
    a: "Two hours for the headline objects — the Rosetta Stone, the Parthenon sculptures, the Egyptian galleries and the Sutton Hoo helmet. A full day barely scratches it: there are around eight million objects and roughly 50,000 on display. Pick two or three galleries rather than attempting a circuit."
...
heroImageSource: https://commons.wikimedia.org/wiki/File:Bloomsbury_Street,_London_-_geograph.org.uk_-_6073643.jpg
...
Bloomsbury has its own share of the commemorative plaques marking where notable people lived or worked. [Browse them on the map](/plaques/?area=bloomsbury).
...
| **Ciao Bella** | Italian | ££ | Long-running Lamb's Conduit trattoria with a pianist |
| **Store Street Espresso** | Coffee | £ | The area's best coffee, five minutes from the museum |
| **The Espresso Room** | Coffee | £ | Tiny counter on Great Ormond Street |
| **Bloomsbury Coffee House** | Cafe | £ | Basement cafe under a student hall; quiet and cheap |
| **Seven Dials Market** | Food hall | £ | Ten minutes south when Bloomsbury's options run out |
...
**Best exit.** For the British Museum, come from **Tottenham Court Road** and approach along Great Russell Street — or better, walk round to the **Montague Place** entrance on the north side, which is far quieter.
...
3. **Eating on Great Russell Street.** The cafes opposite the museum are poor value. Store Street or Marchmont Street are three minutes away.
...
One of the best-value central bases in London: quiet, walkable and close to the Eurostar.
