...
tags: [South Bank, walks, free things to do, Thames, neighbourhoods]
draft: false
faq:
...
<details class="restaurant-map-shell" open>
  ...
  <div class="restaurant-map" data-route-map="south-bank-walk" role="region" aria-label="Numbered map of the South Bank walking route from Westminster to Tower Bridge">
    <p>Loading the map…</p>
  </div>
...
**Brutalist, listed, and free to walk into.** Denys Lasdun's building divides people in exactly the way the Southbank Centre does, and the terraces are the reason to go in whatever you think of the concrete.
...
![Tower Bridge seen along the Thames, both towers and the high walkway in full, under a bright sky](../../assets/articles/south-bank-walk/tower-bridge-from-the-wharf.jpg)

**Crossing it is free** — the road and pavements are a public highway. What is ticketed is the high-level walkways with the glass floor, and the Victorian engine rooms that powered the bascules.
