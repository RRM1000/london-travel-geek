...
area:
  name: "Marylebone"
  zone: "1"
  vibe: "A village high street hidden one street back from Oxford Street"
  walkability: 5
  ...
  nearestStations:
    - name: "Baker Street"
      lines: ["Bakerloo", "Jubilee", "Circle", "Metropolitan", "Hammersmith & City"]
    - name: "Bond Street"
  ...
  nearby:
    - name: "Regent's Park and London Zoo"
      minutes: 10
      note: "North across Marylebone Road for the rose gardens, the boating lake and the zoo."
    - name: "Mayfair"
      slug: "mayfair-area-guide"
      minutes: 12
      note: "South across Oxford Street for Bond Street, the arcades and the Royal Academy."
    - name: "Paddington"
...
faq:
  ...
  - q: "What is Daunt Books?"
    a: "A bookshop on Marylebone High Street in an Edwardian building with oak galleries, skylights and a long stained-glass window at the back. Its main room is arranged by country rather than genre, so travel writing, fiction and history for each place sit together. Free to browse and one of the most photographed shop interiors in London."
heroImage: ../../assets/articles/marylebone-area-guide/marylebone-high-street-london-january-2024-01.jpg
heroImageAlt: "Marylebone High Street on a wet winter afternoon, with the boutiques and mansion blocks of Marylebone Village"
heroImageCredit: "DiscoA340"
heroImageSource: https://commons.wikimedia.org/wiki/File:Marylebone_High_Street,_London_(January_2024)_01.jpg
