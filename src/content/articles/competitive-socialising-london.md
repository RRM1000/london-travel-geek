...
tags: [things to do, activities, groups, nightlife, London experiences]
draft: false
faq:
  - q: "What is competitive socialising?"
    a: "Bars built around a game — darts, mini golf, shuffleboard, axe throwing, ping pong. London has more of them than any other city, and they exist because they solve the problem of what a group of eight people does on a Friday."
  - q: "What is the best escape room in London?"
    a: "Mission: Breakout, built inside the abandoned South Kentish Town Underground station. The room is a real disused Tube station rather than a set, which no other escape room in London can claim."
  - q: "Are these good for large groups?"
    a: "That is what they are for. Most take groups of eight to twelve without difficulty and several are built for corporate bookings. Book ahead — walk-in space at weekends is limited."
  - q: "Are they family friendly?"
    a: "Some. Many are over-18 in the evenings even where children are welcome during the day — the venue is a bar with a game in it. Check the age policy before booking, especially for anything with alcohol at the centre of it."
...
An escape room built inside **South Kentish Town, a real Underground station that has been closed since 1924**. Not a warehouse dressed up to look like one. That is the entire point of the place, and no other escape room in London can make the claim.

Three games run in the station — Codebreakers, The Lost Passenger and UNDER-GROUND 2099 — and the tiled passageways and original fittings do most of the atmospheric work. Each game lasts **60 minutes** and takes **three to six players**. Rooms are private, so you are never mixed in with strangers. All three can run at once, which caps a single visit at **eighteen people**: enough for a work team, not enough for a party of thirty.
...
A **1937 dining car built inside a railway arch**, with three courses and a murder to solve between them. The train never moves but is staged so that it feels as though it does. The current show is Part Deux: Jewel of the Empire, and the menu is written by Lunar — two AA rosettes and a place in the Michelin Guide — which is more than most immersive dinners bother with.
...
The old Bunga Bunga cabaret is gone. What replaced it in September 2025 is a **1990s world built out in full**, entered through a flickering Blockbuster-style video shop and down into shelves of dusty VHS tapes. Playable Mortal Kombat, Street Fighter and Tekken 2 cabinets sit around the room, there is a Jurassic Park pinball table, and the toilets turn into a strobe-lit rave on the hour.
...
**Twenty-one glass cubes across three floors**, playing seven games from the show against a running score. Beat 10,000 points and you have beaten the Cube. The production values are real, the lighting and sound are the show's own, and it is as close as anyone gets to actually being on it.

Two facts decide whether it suits you. First, **it is played in fours, in a 2v2 format** — book two tickets and you are paired with another pair on arrival. Second, **it is the most expensive game per head in this guide**: adults from £48.65 on Tuesday, Wednesday and Friday, £57.69 on Thursday and Saturday, £55.06 on Sunday, with 9- to 17-year-olds from £34.06. Closed Mondays.
...
Shuffleboard given the same treatment by the same people — four games, table service, a board that scores itself. It is the easiest game in this guide to pick up cold, which makes it the safest pick for a group with mixed enthusiasm and no shared skill.
...
The polished one, and now the only one — the City site has gone. Crazy golf courses, street food from Pizza Pilgrims, Patty & Bun, Breddos Tacos and Crosstown, a carnival games hall alongside, and a terrace with a retractable roof.
...
The one that is really a sports bar with games bolted on, and better for it if what you want is to watch something as well as play. **27 HD screens showing up to three matches at once**, alongside interactive darts, pool, ping pong, shuffleboard, mini golf, beer and prosecco pong, and karaoke.
...
The answer when a group cannot agree on anything. Under one roof: indoor karting, ten-pin bowling, AR digital darts, urban street golf, shuffleboard, batting cages, beer pong, Hologate VR, Sandbox VR, Immersive Gamebox and a Pixel Hyperfloor.
...
Open **11am to 10pm Monday to Thursday, to 11pm on Friday and Saturday**, and from 10am at weekends. It is not a subtle building and is not trying to be. But nothing else in London puts this many formats in one place, which is exactly why it works for a mixed group.
...
Before the format had a name, London had all of this in basements and leisure complexes, and most of it is still there at a fraction of the price.

### Bloomsbury Lanes

*Bedford Way, WC1H 9EU · bowling, karaoke and darts · from £45 a lane*

A basement bowling alley with an American diner attached, karaoke rooms and a proper bar — the last of the old-style central London alleys, and comfortably the cheapest formal option in this guide.
...
A genuine north London institution: bowling, **14 electronic pool tables**, karaoke and a dance floor, in a building that has changed very little. Late, loud, not remotely polished, and priced where the new venues cannot follow.
...
Not central, not fashionable, and the cheapest way to bowl in London with a guaranteed lane. Five sites around the edge of the city, each pairing lanes with some combination of karaoke rooms, laser tag, escape rooms, pool, table tennis and an arcade.

**A game booked online is £9.95**, and the standing offers do more work than the headline: **Tenpin Tuesday is 50% off bowling**, Friday Frenzy is 20% off up to three games, and there are meal deals from £10 for two games and food.

Karaoke is **£25 for a 30-minute room taking up to ten people**, which is cheaper per head than any central karaoke room in this guide. Laser tag is £36 for 30 minutes, and a bowling party is £13.99 a child.

Acton opens **10am to 1am Monday to Thursday and to 2am on Friday and Saturday**, from 9am at weekends. A game takes roughly ten minutes a player, which is the number to plan an evening around.

### Free table tennis: King's Cross and Merchant Square

*Granary Square and Paddington Basin · free · no booking*

The part nobody mentions. Two central London estates keep table tennis tables that cost nothing and take no booking at all, which turns an hour of ping pong from £6 a head into free.
...
Neither is a night out and neither pretends to be. Both are a perfectly good ninety minutes before you go and spend money somewhere else.
...
*This guide is independent and contains no paid placements. Every venue was status-checked against its own website or booking system on 1 September 2026. Where a price or age limit is described here as not published, that means the venue itself does not state it — not that it does not exist.*
